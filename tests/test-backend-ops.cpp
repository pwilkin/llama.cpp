...
static std::vector<std::unique_ptr<test_case>> make_test_cases_perf() {
 ...
 // High resolution output (large NPQ)
    ...
    for (int n : {512, 2048}) {
        test_cases.emplace_back(new test_mul_mat(GGML_TYPE_BF16, GGML_TYPE_F32,   4, n, 10240, {1, 1}, {1, 1}));
        test_cases.emplace_back(new test_mul_mat(GGML_TYPE_BF16, GGML_TYPE_F32,  48, n,  2560, {1, 1}, {1, 1}));
        test_cases.emplace_back(new test_mul_mat(GGML_TYPE_BF16, GGML_TYPE_F32,  64, n, 10240, {1, 1}, {1, 1}));
    }
