...
const common_chat_msg message_assist_call_code_interpreter =
    simple_assist_msg("", "", "code_interpreter", "{\"code\":\"print('hey')\"}");
...
static void test_template_output_parsers() {
    ...
    }
    {
        ...
        assert_equals(message_assist_call,
                      common_chat_parse("{\"name\": \"special_function\", \"parameters\": {\"arg1\": 1}}",
                                        /* is_partial= */ false, { COMMON_CHAT_FORMAT_LLAMA_3_X }));
    ...
    {
        // Functionary v3.1 migrated to PEG format
    }
    {
        ...
        assert_msg_equals(message_assist_call_python_lines_unclosed,
                          common_chat_parse("python\n"
                                            "# This is a program:\n"
                                            "print('hey')",
                                            /* is_partial= */ true, { COMMON_CHAT_FORMAT_FUNCTIONARY_V3_2 }));
        assert_msg_equals(message_assist_call,
                          common_chat_parse("special_function\n"
                                            "{\"arg1\": 1} \n                    ",
                                            /* is_partial= */ false, { COMMON_CHAT_FORMAT_FUNCTIONARY_V3_2 }));
    ...
    }
    {
        ...
        assert_msg_equals(message_assist_thoughts_unparsed_deepseek,
                          common_chat_parse("<think>I'm\nthinking</think>Hello, world!\nWhat's up?",
                                            /* is_partial= */ false, { COMMON_CHAT_FORMAT_DEEPSEEK_R1 }));
        assert_msg_equals(message_assist_thoughts,
                          common_chat_parse("<think>I'm\nthinking</think>Hello, world!\nWhat's up?",
                                            /* is_partial= */ false,
                                            {
        ...
        assert_msg_equals(
            ...
            common_chat_parse("<think>I'm\nthinking</think>\n\n"
                              ...
                              /* is_partial= */ false, { COMMON_CHAT_FORMAT_DEEPSEEK_R1 }));
        assert_msg_equals(message_assist_call,
                          common_chat_parse("<｜tool▁calls｜>function<｜tool▁sep｜>special_function\n"
                                            "```json\n"
                                            "{\"arg1\": 1}\n"
                                            "```<｜tool▁call▁end｜><｜tool▁calls▁end｜>",
                                            /* is_partial= */ false, { COMMON_CHAT_FORMAT_DEEPSEEK_R1 }));
    ...
    if (false) {
        ...
        assert_msg_equals(message_assist, common_chat_parse("Hello, world!\nWhat's up?",
                                                            /* is_partial= */ false, { COMMON_CHAT_FORMAT_GRANITE }));
        assert_msg_equals(message_assist, common_chat_parse("Hello, world!\nWhat's up?",
                                                            /* is_partial= */ true, { COMMON_CHAT_FORMAT_GRANITE }));
        ...
        assert_msg_equals(
            message_assist_call,
            common_chat_parse("<|tool_call|>[{\"name\": \"special_function\", \"arguments\": {\"arg1\": 1}}]",
                              /* is_partial= */ false, { COMMON_CHAT_FORMAT_GRANITE }));
        assert_msg_equals(message_assist_call_empty_args,
                          common_chat_parse("<|tool_call|>[{\"name\": \"special_function\"",
                                            /* is_partial= */ true, { COMMON_CHAT_FORMAT_GRANITE }));
        assert_msg_equals(message_assist_call_cutoff_args,
                          common_chat_parse("<|tool_call|>[{\"name\": \"special_function\", \"arguments\": {\"arg",
                                            /* is_partial= */ true, { COMMON_CHAT_FORMAT_GRANITE }));
        assert_msg_equals(message_assist_call_cutoff_args,
                          common_chat_parse("<|tool_call|>[{\"name\": \"special_function\", \"arguments\": {\"arg",
        ...
        assert_msg_equals(message_assist_call_thoughts,
                          common_chat_parse("<think>I'm\nthinking</think><|tool_call|>[{\"name\": "
                                            "\"special_function\", \"arguments\": {\"arg1\": 1}, {",
                                            /* is_partial= */ true,
                                            {
                                                /* .format = */ COMMON_CHAT_FORMAT_GRANITE,
                                                /* .reasoning_format = */ COMMON_REASONING_FORMAT_DEEPSEEK,
    ...
    if (false) {
        {
            ...
            assert_msg_equals(simple_assist_msg("", "I'm\nthink"),
                              common_chat_parse("<|channel|>analysis<|message|>I'm\nthink",
                                                /* is_partial= */ true,
                                                {
            ...
            assert_msg_equals(simple_assist_msg("", "I'm\nthinking", "special_function", "{\"arg1\": 1}"),
                              common_chat_parse("<|channel|>analysis<|message|>I'm\nthinking<|end|>"
                                                "<|start|>assistant<|channel|>analysis to=functions.special_function "
                                                "<|constrain|>json<|message|>{\"arg1\": 1}",
                                                /* is_partial= */ false,
                                                {
                                                    /* .format = */ COMMON_CHAT_FORMAT_GPT_OSS,
            ...
            assert_msg_equals(
                simple_assist_msg("<|channel|>analysis<|message|>I'm\nthinking<|end|>Hello, world!\nWhat's up?"),
                common_chat_parse("<|channel|>analysis<|message|>I'm\nthinking<|end|>"
                                  "<|start|>assistant<|channel|>final<|message|>Hello, world!\nWhat's up?",
                                  /* is_partial= */ false,
                                  {
            ...
            assert_msg_equals(
                simple_assist_msg("", "", "special_function", "{\"arg1\": 1}"),
                common_chat_parse(
            ...
            assert_msg_equals(simple_assist_msg("", "I'm\nthinking", "special_function", "{\"arg1\": 1}"),
                              common_chat_parse("<|channel|>analysis<|message|>I'm\nthinking<|end|>"
                                                "<|start|>assistant to=functions.special_function<|channel|>analysis "
                                                "<|constrain|>json<|message|>{\"arg1\": 1}",
                                                /* is_partial= */ false,
                                                {
                                                    /* .format = */ COMMON_CHAT_FORMAT_GPT_OSS,
        ...
        }
        {
            ...
            assert_equals(COMMON_CHAT_FORMAT_SEED_OSS,
                          common_chat_templates_apply(tmpls.get(), inputs_no_tools).format);
            ...
            assert_msg_equals(simple_assist_msg("Hello, world!", "I'm thinking about the answer"),
                              common_chat_parse("<seed:think>I'm thinking about the answer</seed:think>Hello, world!",
                                                /* is_partial= */ false,
                                                {
            ...
            msg_budget_reflect.content =
                "<seed:cot_budget_reflect>Token usage: 45/1000\nI should continue thinking to find the best "
                "solution.</seed:cot_budget_reflect>I need to calculate this step by step.";
            msg_budget_reflect.reasoning_content =
                "Token usage: 45/1000\nI should continue thinking to find the best solution.";
            assert_msg_equals(msg_budget_reflect,
                              common_chat_parse("<seed:think>Token usage: 45/1000\nI should continue thinking to find "
                                                "the best solution.</seed:think>"
                                                "<seed:cot_budget_reflect>Token usage: 45/1000\nI should continue "
                                                "thinking to find the best solution.</seed:cot_budget_reflect>"
            ...
            assert_msg_equals(msg_tool_call,
                              common_chat_parse("<seed:tool_call>\n"
                                                "<function=calculate_sum>\n"
                                                "<parameter=numbers>[1, 2, 3]</parameter>\n"
                                                "</function>\n"
                                                "</seed:tool_call>",
                                                /* is_partial= */ false, { COMMON_CHAT_FORMAT_SEED_OSS }));
            ...
            assert_msg_equals(msg_reasoning_tool,
                              common_chat_parse("<seed:think>I need to calculate the sum of these numbers</seed:think>"
                                                "<seed:tool_call>\n"
                                                "<function=calculate_sum>\n"
                                                "<parameter=numbers>[1, 2, 3]</parameter>\n"
                                                "</function>\n"
            ...
            for (std::size_t i = std::string("<seed:tool_call>").length(); i < tool_msg.length() - 1; i++) {
                ...
                auto partial_res =
                    common_chat_parse(partial, true, { COMMON_CHAT_FORMAT_SEED_OSS, COMMON_REASONING_FORMAT_DEEPSEEK });
                if (partial_res.tool_calls.size() < previousToolCalls) {
                    throw std::runtime_error("Tool call size decreased on partial: " + partial + " from " +
                                             std::to_string(previousToolCalls) + " to " +
                                             std::to_string(partial_res.tool_calls.size()));
                }
            ...
            assert_msg_equals(simple_assist_msg("", "", "calculate_sum", "{\"numbers\":"),
                              common_chat_parse("<seed:tool_call>\n"
                                                "<function=calculate_sum>\n"
                                                "<parameter=numbers>[1,\n",
            ...
            assert_msg_equals(simple_assist_msg("", "I was thinking"),
                              common_chat_parse("<seed:think>I was thinking",
                                                /* is_partial= */ true,
                                                {
                                                    /* .format = */ COMMON_CHAT_FORMAT_SEED_OSS,
                                                    /* .reasoning_format = */ COMMON_REASONING_FORMAT_DEEPSEEK,
            ...
            assert_msg_equals(simple_assist_msg("This is a simple response without reasoning."),
                              common_chat_parse("This is a simple response without reasoning.",
                                                /* is_partial= */ false, { COMMON_CHAT_FORMAT_SEED_OSS }));
        }
        {
            ...
            assert_equals(COMMON_CHAT_FORMAT_NEMOTRON_V2,
                          common_chat_templates_apply(tmpls.get(), inputs_no_tools).format);
            assert_equals(COMMON_CHAT_FORMAT_NEMOTRON_V2,
                          common_chat_templates_apply(tmpls.get(), inputs_tools).format);
            ...
            // Test parsing regular content
            assert_msg_equals(message_assist,
                              common_chat_parse("Hello, world!\nWhat's up?",
                                                /* is_partial= */ false, { COMMON_CHAT_FORMAT_NEMOTRON_V2 }));
            ...
            // Test parsing tool calls with thinking
            assert_msg_equals(message_assist_call_thoughts,
                              common_chat_parse("<think>I'm\nthinking</think><TOOLCALL>[{\"name\": "
                                                "\"special_function\", \"arguments\": {\"arg1\": 1}}]</TOOLCALL>",
                                                /* is_partial= */ false,
                                                { /*  .format = */ COMMON_CHAT_FORMAT_NEMOTRON_V2,
                                                  /*  .reasoning_format = */ COMMON_REASONING_FORMAT_DEEPSEEK }));
            ...
            assert_msg_equals(message_assist_call_content,
                              common_chat_parse("<TOOLCALL>[{\"name\": \"special_function\", \"arguments\": {\"arg1\": "
                                                "1}}]</TOOLCALL>Hello, world!\nWhat's up?",
                                                /* is_partial= */ false, { COMMON_CHAT_FORMAT_NEMOTRON_V2 }));

            // Test tool calls with extra content AND thinking
            assert_msg_equals(
                message_assist_call_thoughts_content,
                common_chat_parse("<think>I'm\nthinking</think><TOOLCALL>[{\"name\": \"special_function\", "
                                  "\"arguments\": {\"arg1\": 1}}]</TOOLCALL>Hello, world!\nWhat's up?",
                                  /* is_partial= */ false,
                                  { /*  .format = */ COMMON_CHAT_FORMAT_NEMOTRON_V2,
                                    /*  .reasoning_format = */ COMMON_REASONING_FORMAT_DEEPSEEK }));
        ...
        }
        {
            ...
            assert_msg_equals(simple_assist_msg("REASONING</think>ok", ""),
                              common_chat_parse("REASONING</think>ok",
                                                /* is_partial= */ false,
                                                {
                                                    COMMON_CHAT_FORMAT_DEEPSEEK_V3_1,
                                                    /* .reasoning_format = */ COMMON_REASONING_FORMAT_NONE,
            ...
            assert_msg_equals(simple_assist_msg("", "", "get_time", "{\"city\":\"Tokyo\"}"),
                              common_chat_parse("<｜tool▁calls▁begin｜><｜tool▁call▁begin｜>get_time<｜tool▁sep｜>{"
            ...
            assert_msg_equals(
                ...
                common_chat_parse("CONTENT<｜tool▁calls▁begin｜><｜tool▁call▁begin｜>get_time<｜tool▁sep｜>{\"city\": "
                                  "\"Paris\"}<｜tool▁call▁end｜><｜tool▁call▁begin｜>get_weather<｜tool▁sep｜>{"
            ...
            assert_msg_equals(
                simple_assist_msg("",
                                  "REASONING<｜tool▁calls▁begin｜><｜tool▁call▁begin｜>get_time2<｜tool▁sep｜>{"
                                  "\"city\": \"Tokyo2\"}<｜tool▁call▁end｜><｜tool▁calls▁end｜>REASONING",
                                  "get_time", "{\"city\":\"Tokyo\"}"),
                common_chat_parse(
                    "REASONING<｜tool▁calls▁begin｜><｜tool▁call▁begin｜>get_time2<｜tool▁sep｜>{\"city\": "
                    "\"Tokyo2\"}<｜tool▁call▁end｜><｜tool▁calls▁end｜>REASONING</"
                    "think><｜tool▁calls▁begin｜><｜tool▁call▁begin｜>get_time<｜tool▁sep｜>{\"city\": "
                    "\"Tokyo\"}<｜tool▁call▁end｜><｜tool▁calls▁end｜>",
                    /* is_partial= */ false,
                    {
                        COMMON_CHAT_FORMAT_DEEPSEEK_V3_1,
            ...
            assert_msg_equals(
                simple_assist_msg("REASONING", "", "get_time", "{\"city\":\"Tokyo\"}"),
                common_chat_parse("REASONING<｜tool▁calls▁begin｜><｜tool▁call▁begin｜>get_time<｜tool▁sep｜>{\"city\":"
                                  " \"Tokyo\"}<｜tool▁call▁end｜><｜tool▁calls▁end｜>",
                                  /* is_partial= */ false,
                                  {
                                      COMMON_CHAT_FORMAT_DEEPSEEK_V3_1,
            ...
            assert_msg_equals(
                simple_assist_msg("",
                                  "REASONING<｜tool▁calls▁begin｜><｜tool▁call▁begin｜>get_time<｜tool▁sep｜>{\"city\":"
                                  " \"Tokyo\"}<｜tool▁call▁end｜><｜tool▁calls▁end｜>",
                                  "", ""),
                common_chat_parse("REASONING<｜tool▁calls▁begin｜><｜tool▁call▁begin｜>get_time<｜tool▁sep｜>{\"city\":"
                                  " \"Tokyo\"}<｜tool▁call▁end｜><｜tool▁calls▁end｜>",
            ...
            assert_msg_equals(simple_assist_msg("CONTENT", ""),
                              common_chat_parse("CONTENT",
                                                /* is_partial= */ false,
                                                {
                                                    COMMON_CHAT_FORMAT_DEEPSEEK_V3_1,
                                                    /* .reasoning_format = */ COMMON_REASONING_FORMAT_DEEPSEEK,
        ...
        }
        {
            ...
            assert_msg_equals(message_assist,
                              common_chat_parse("Hello, world!\nWhat's up?",
                                                /* is_partial= */ false, { COMMON_CHAT_FORMAT_APERTUS }));

            // Test parsing content with thinking
            assert_msg_equals(
                message_assist_thoughts,
                common_chat_parse("<|inner_prefix|>I'm\nthinking<|inner_suffix|>Hello, world!\nWhat's up?",
                                  /* is_partial= */ false,
                                  {
            ...
            assert_msg_equals(
                message_assist_call,
                common_chat_parse("<|tools_prefix|>[{\"special_function\": {\"arg1\": 1}}]<|tools_suffix|>",
                                  /* is_partial= */ false, { COMMON_CHAT_FORMAT_APERTUS }));

            // Test parsing tool calls with thinking
            assert_msg_equals(message_assist_call_thoughts,
                              common_chat_parse("<|inner_prefix|>I'm\nthinking<|inner_suffix|><|tools_prefix|>[{"
                                                "\"special_function\": {\"arg1\": 1}}]<|tools_suffix|>",
                                                /* is_partial= */ false,
                                                { /* .format = */ COMMON_CHAT_FORMAT_APERTUS,
                                                  /* .reasoning_format = */ COMMON_REASONING_FORMAT_DEEPSEEK }));
...
<|im_start|>assistant
            ...
            assert_msg_equals(message_assist,
                              common_chat_parse("Hello, world!\nWhat's up?",
                                                /* is_partial= */ false, { COMMON_CHAT_FORMAT_LFM2_WITH_JSON_TOOLS }));
            ...
            assert_msg_equals(msg_single_tool_call,
                              common_chat_parse("<|tool_call_start|>[{\"name\": \"special_function\", \"arguments\": "
                                                "{\"arg1\": 1}}]<|tool_call_end|>",
                                                /* is_partial= */ false, { COMMON_CHAT_FORMAT_LFM2_WITH_JSON_TOOLS }));
            ...
            assert_msg_equals(msg_tool_call_string,
                              common_chat_parse("<|tool_call_start|>[{\"name\": \"get_weather\", \"arguments\": "
            ...
            assert_msg_equals(msg_multi_args,
                              common_chat_parse("<|tool_call_start|>[{\"name\": \"calculate\", \"arguments\": {\"x\": "
                                                "10, \"y\": 20, \"operation\": \"add\"}}]<|tool_call_end|>",
                                                /* is_partial= */ false, { COMMON_CHAT_FORMAT_LFM2_WITH_JSON_TOOLS }));
            ...
            assert_msg_equals(
                msg_multiple_tools,
                common_chat_parse(
                    "<|tool_call_start|>[{\"name\": \"get_weather\", \"arguments\": {\"location\": \"Paris\"}}, "
                    "{\"name\": \"get_time\", \"arguments\": {\"timezone\": \"UTC\"}}]<|tool_call_end|>",
                    /* is_partial= */ false, { COMMON_CHAT_FORMAT_LFM2_WITH_JSON_TOOLS }));
            ...
            assert_msg_equals(
                ...
                common_chat_parse("Let me check the weather for you.<|tool_call_start|>[{\"name\": \"get_weather\", "
                                  "\"arguments\": {\"location\": \"Paris\"}}]<|tool_call_end|>",
                                  /* is_partial= */ false, { COMMON_CHAT_FORMAT_LFM2_WITH_JSON_TOOLS }));
            ...
            assert_msg_equals(msg_content_after_tool,
                              common_chat_parse("<|tool_call_start|>[{\"name\": \"get_weather\", \"arguments\": "
                                                "{\"location\": \"Paris\"}}]<|tool_call_end|>Here's the result.",
                                                /* is_partial= */ false, { COMMON_CHAT_FORMAT_LFM2_WITH_JSON_TOOLS }));
...

        {
            ...
            assert_equals(COMMON_CHAT_FORMAT_MINIMAX_M2,
                          common_chat_templates_apply(tmpls.get(), inputs_no_tools).format);
            ...
            assert_msg_equals(message_assist,
                              common_chat_parse("Hello, world!\nWhat's up?",
                                                /* is_partial= */ false, { COMMON_CHAT_FORMAT_MINIMAX_M2 }));
            ...
            // Test parsing tool calls
            assert_msg_equals(message_assist_call,
                              common_chat_parse("<minimax:tool_call><invoke name=\"special_function\"><parameter "
                                                "name=\"arg1\">1</parameter></invoke></minimax:tool_call>",
                                                /* is_partial= */ false, { COMMON_CHAT_FORMAT_MINIMAX_M2 }));
            ...
            assert_msg_equals(
                message_assist_call_thoughts,
                common_chat_parse(
                    "<think>I'm\nthinking</think><minimax:tool_call><invoke name=\"special_function\"><parameter "
                    "name=\"arg1\">1</parameter></invoke></minimax:tool_call>",
                    /* is_partial= */ false,
                    { /*  .format = */ COMMON_CHAT_FORMAT_MINIMAX_M2,
                      /*  .reasoning_format = */ COMMON_REASONING_FORMAT_DEEPSEEK }));
            ...
            assert_msg_equals(
                message_assist_call_content,
                common_chat_parse("<minimax:tool_call><invoke name=\"special_function\"><parameter "
                                  "name=\"arg1\">1</parameter></invoke></minimax:tool_call>Hello, world!\nWhat's up?",
                                  /* is_partial= */ false, { COMMON_CHAT_FORMAT_MINIMAX_M2 }));
            ...
            test_parser_with_streaming(
                ...
                "name=\"special_function\"><parameter name=\"arg1\">1</parameter></invoke></minimax:tool_call>",
                [&](const std::string & msg) {
                    return common_chat_parse(msg, /* is_partial= */ true,
                                             { /*  .format = */ COMMON_CHAT_FORMAT_MINIMAX_M2,
                                               /*  .reasoning_format = */ COMMON_REASONING_FORMAT_DEEPSEEK });
                });
            test_parser_with_streaming(
                message_assist_call_thoughts_unparsed,
                "<think>I'm\nthinking</think>\n\n<minimax:tool_call><invoke name=\"special_function\"><parameter "
                "name=\"arg1\">1</parameter></invoke></minimax:tool_call>",
                [&](const std::string & msg) {
                    return common_chat_parse(msg, /* is_partial= */ true,
                                             { /*  .format = */ COMMON_CHAT_FORMAT_MINIMAX_M2,
            ...
            test_templates(tmpls.get(), end_tokens, message_assist_call_noopt, tools,
                           ...
                           /* ignore_whitespace_differences= */ true);
            test_templates(
                tmpls.get(), end_tokens, message_assist_call_withopt, tools,
                "<minimax:tool_call>\n<invoke name=\"special_function_with_opt\">\n<parameter "
                "name=\"arg1\">1</parameter>\n<parameter name=\"arg2\">2</parameter>\n</invoke>\n</minimax:tool_call>",
                /* expect_grammar_triggered= */ true,
                /* test_grammar_if_triggered= */ true,
...

        {
            ...
            assert_msg_equals(message_assist,
                              common_chat_parse("Hello, world!\nWhat's up?",
                                                /* is_partial= */ false, { COMMON_CHAT_FORMAT_GLM_4_5 }));
            ...
            test_parser_with_streaming(
                simple_assist_msg("", "", "complex_function",
                ...
                "</tool_call>",
                [&](const std::string & msg) {
                    return common_chat_parse(msg, /* is_partial= */ true, { COMMON_CHAT_FORMAT_GLM_4_5 });
                });
            test_parser_with_streaming(
                simple_assist_msg("", "", "web_search",
                                  "{\"query\":\"\\\"From Zero\\\" Linkin Park album tracklist complete "
                                  "songs\",\"limit\":3,\"type\":\"text\"}"),
            ...
            test_parser_with_streaming(
                simple_assist_msg("Hello, world!\n\nWhat's up?", "I'm\nthinkingThinking2", "special_function",
                                  "{\"arg1\": 1}"),
                "\n<think>I'm\nthinking</think>Hello, world!\n<think>Thinking2</think>What's "
                "up?\n<tool_call>special_function\n<arg_key>arg1</arg_key>\n<arg_value>1</arg_value>\n</tool_call>",
                [&](const std::string & msg) {
                    return common_chat_parse(msg, /* is_partial= */ true,
                                             { /*  .format = */ COMMON_CHAT_FORMAT_GLM_4_5,
...

        {
            ...
            assert_msg_equals(message_assist,
                              common_chat_parse("Hello, world!\nWhat's up?",
                                                /* is_partial= */ false, { COMMON_CHAT_FORMAT_KIMI_K2 }));
            ...
            assert_msg_equals(
                message_assist_call,
                common_chat_parse("<|tool_calls_section_begin|><|tool_call_begin|>functions.special_function:0<|tool_"
                                  "call_argument_begin|>{\"arg1\": 1}<|tool_call_end|><|tool_calls_section_end|>",
                                  /* is_partial= */ false, { COMMON_CHAT_FORMAT_KIMI_K2 }));
            ...
            assert_msg_equals(
                message_assist_call_thoughts,
                common_chat_parse("<think>I'm\nthinking</"
                                  "think><|tool_calls_section_begin|><|tool_call_begin|>functions.special_function:0<|"
                                  "tool_call_argument_begin|>{\"arg1\": 1}<|tool_call_end|><|tool_calls_section_end|>",
                                  /* is_partial= */ false,
                                  { /*  .format = */ COMMON_CHAT_FORMAT_KIMI_K2,
                                    /*  .reasoning_format = */ COMMON_REASONING_FORMAT_DEEPSEEK }));
            ...
            assert_msg_equals(
                message_assist_call_content,
                common_chat_parse(
                    "<|tool_calls_section_begin|><|tool_call_begin|>functions.special_function:0<|tool_call_argument_"
                    "begin|>{\"arg1\": 1}<|tool_call_end|><|tool_calls_section_end|>Hello, world!\nWhat's up?",
                    /* is_partial= */ false, { COMMON_CHAT_FORMAT_KIMI_K2 }));
            ...
            assert_msg_equals(
                ...
                common_chat_parse(
                    "<think>I'm\nthinking</"
                    "think><|tool_calls_section_begin|><|tool_call_begin|>functions.special_function:0<|tool_call_"
                    "argument_begin|>{\"arg1\": 1}<|tool_call_end|><|tool_calls_section_end|>Hello, world!\nWhat's up?",
                    /* is_partial= */ false,
                    { /*  .format = */ COMMON_CHAT_FORMAT_KIMI_K2,
                      /*  .reasoning_format = */ COMMON_REASONING_FORMAT_DEEPSEEK }));
            ...
            test_parser_with_streaming(
                ...
                "<think>I'm\nthinking\n</think>Hello, world!\nWhat's "
                "up?\n<|tool_calls_section_begin|><|tool_call_begin|>functions.special_function:0<|tool_call_argument_"
                "begin|>{\"arg1\": 1}<|tool_call_end|><|tool_calls_section_end|>",
                [&](const std::string & msg) {
                    return common_chat_parse(msg, /* is_partial= */ true,
                                             { /*  .format = */ COMMON_CHAT_FORMAT_KIMI_K2,
                                               /*  .reasoning_format = */ COMMON_REASONING_FORMAT_DEEPSEEK });
            ...
            test_parser_with_streaming(
                message_assist_call_thoughts_unparsed,
                "<think>I'm\nthinking</"
                "think>\n\n<|tool_calls_section_begin|><|tool_call_begin|>functions.special_function:0<|tool_call_"
                "argument_begin|>{\"arg1\": 1}<|tool_call_end|><|tool_calls_section_end|>",
                [&](const std::string & msg) {
                    return common_chat_parse(msg, /* is_partial= */ true,
                                             { /*  .format = */ COMMON_CHAT_FORMAT_KIMI_K2,
                                               /*  .reasoning_format = */ COMMON_REASONING_FORMAT_NONE });
            ...
            test_parser_with_streaming(
                message_assist_call_withopt,
                "<|tool_calls_section_begin|><|tool_call_begin|>functions.special_function_with_opt:0<|tool_call_"
                "argument_begin|>{\"arg1\": 1, \"arg2\": 2}<|tool_call_end|><|tool_calls_section_end|>",
                [&](const std::string & msg) {
                    return common_chat_parse(msg, /* is_partial= */ true,
                                             { /*  .format = */ COMMON_CHAT_FORMAT_KIMI_K2,
                                               /*  .reasoning_format = */ COMMON_REASONING_FORMAT_NONE });
            ...
            test_parser_with_streaming(
                ...
                "<think>I'm\nthinking</think>Hello, world!\nWhat's "
                "up?\n<|tool_calls_section_begin|><|tool_call_begin|>functions.special_function:0<|tool_call_argument_"
                "begin|>{\"arg1\": \"123456\"}<|tool_call_end|><|tool_calls_section_end|>",
                [&](const std::string & msg) {
                    return common_chat_parse(msg, /* is_partial= */ true,
                                             { /*  .format = */ COMMON_CHAT_FORMAT_KIMI_K2,
                                               /*  .reasoning_format = */ COMMON_REASONING_FORMAT_DEEPSEEK });
            ...
            test_parser_with_streaming(
                ...
                "<think>I'm\nthinking</think>Hello, world!\nWhat's "
                "up?\n<|tool_calls_section_begin|><|tool_call_begin|>functions.special_function:0<|tool_call_argument_"
                "begin|>{\"arg1\": [1, 2, \"345\", 6]}<|tool_call_end|><|tool_calls_section_end|>",
                [&](const std::string & msg) {
                    return common_chat_parse(msg, /* is_partial= */ true,
                                             { /*  .format = */ COMMON_CHAT_FORMAT_KIMI_K2,
                                               /*  .reasoning_format = */ COMMON_REASONING_FORMAT_DEEPSEEK });
            ...
            test_parser_with_streaming(
                simple_assist_msg("Hello, world!\nWhat's up?", "I'm\nthinking", "special_function",
                                  "{\"arg1\": {\"12\": 34, \"5\": [67, 8], \"9\": \"10\"}}"),
                "<think>I'm\nthinking</think>Hello, world!\nWhat's "
                "up?\n<|tool_calls_section_begin|><|tool_call_begin|>functions.special_function:0<|tool_call_argument_"
                "begin|>{\"arg1\": {\"12\": 34, \"5\": [67, 8], \"9\": "
                "\"10\"}}<|tool_call_end|><|tool_calls_section_end|>",
                [&](const std::string & msg) {
                    return common_chat_parse(msg, /* is_partial= */ true,
                                             { /*  .format = */ COMMON_CHAT_FORMAT_KIMI_K2,
                                               /*  .reasoning_format = */ COMMON_REASONING_FORMAT_DEEPSEEK });
            ...
            test_parser_with_streaming(
                ...
                [&](const std::string & msg) {
                    return common_chat_parse(msg, /* is_partial= */ true, { COMMON_CHAT_FORMAT_KIMI_K2 });
                });
            test_parser_with_streaming(
                simple_assist_msg("", "", "web_search",
                                  "{\"query\":\"\\\"From Zero\\\" Linkin Park album tracklist complete "
            ...
            test_parser_with_streaming(
                simple_assist_msg("", "", "read_file",
                                  "{\"args\": [{\"path\": \"src/providers/ThemeProvider.tsx\"}, {\"path\": "
                                  "\"src/components/Header.tsx\"}, {\"path\": \"src/components/ThemeToggle.tsx\"}, "
                                  "{\"path\": \"src/app/globals.css\"}, {\"path\": \"src/app/layout.tsx\"}]}"),
                "<|tool_calls_section_begin|><|tool_call_begin|>functions.read_file:0<|tool_call_argument_begin|>"
                "{\"args\": [{\"path\": \"src/providers/ThemeProvider.tsx\"}, {\"path\": "
                "\"src/components/Header.tsx\"}, {\"path\": \"src/components/ThemeToggle.tsx\"}, {\"path\": "
                "\"src/app/globals.css\"}, {\"path\": \"src/app/layout.tsx\"}]}"
                "<|tool_call_end|><|tool_calls_section_end|>",
                [&](const std::string & msg) {
                    return common_chat_parse(msg, /* is_partial= */ true, { COMMON_CHAT_FORMAT_KIMI_K2 });
                });
            test_parser_with_streaming(
                simple_assist_msg(
                    ...
                    "read_file", "{\"files\": [{\"path\": \"src/app/Partners.tsx\", \"line_ranges\": [\"1-100\"]}]}"),
                "Let me start by examining the relevant files to understand the current implementation."
                "<|tool_calls_section_begin|><|tool_call_begin|>functions.read_file:0<|tool_call_argument_begin|>"
            ...
            multi_tool_msg.tool_calls.push_back(
                { "read_file", "{\"files\": [{\"path\": \"src/app/Partners.tsx\", \"line_ranges\": [\"1-100\"]}]}",
                  "" });
            multi_tool_msg.tool_calls.push_back({ "web_search",
                                                  "{\"query\":\"\\\"From Zero\\\" Linkin Park album tracklist complete "
                                                  "songs\",\"limit\":3,\"type\":\"text\"}",
                                                  "" });
            multi_tool_msg.tool_calls.push_back(
            ...
            test_parser_with_streaming(multi_tool_msg,
                                       ...
                                       [&](const std::string & msg) {
                                           return common_chat_parse(
                                               msg, /* is_partial= */ true,
                                               { COMMON_CHAT_FORMAT_KIMI_K2, COMMON_REASONING_FORMAT_DEEPSEEK });
                                       });
            test_parser_with_streaming(
                simple_assist_msg("", "I'm thinking", "complex_function_in_think",
                                  "{\"name\":\"John Doe\",\"age\":30,\"active\":true,\"score\":95.5}"),
                "<think>I'm "
                "thinking<|tool_calls_section_begin|><|tool_call_begin|>functions.complex_function_in_think:0<|tool_"
                "call_argument_begin|>"
                "{\"name\": \"John Doe\", \"age\": 30, \"active\": true, \"score\": 95.5}"
                "<|tool_call_end|><|tool_calls_section_end|>",
                [&](const std::string & msg) {
            ...
            test_parser_with_streaming(
                simple_assist_msg("Hello", "I'm thinkingI'm still thinking", "complex_function_in_think",
                                  "{\"name\":\"John Doe\",\"age\":30,\"active\":true,\"score\":95.5}"),
                "<think>I'm "
                "thinking<|tool_calls_section_begin|><|tool_call_begin|>functions.complex_function_in_think:0<|tool_"
                "call_argument_begin|>"
            ...
            conversation_with_tools.messages.push_back(
                simple_assist_msg("Let's do it", "Think first", "complex_function",
                                  "{\"name\":\"John Doe\",\"age\":30,\"active\":true,\"score\":95.5}"));
            conversation_with_tools.messages.push_back({
                "tool",
                "Tool response 1",
            ...
            conversation_with_tools.messages.push_back(
                simple_assist_msg("Continue", "Think next", "web_search",
                                  "{\"query\":\"\\\"From Zero\\\" Linkin Park album tracklist complete "
                                  "songs\",\"limit\":3,\"type\":\"text\"}"));
            conversation_with_tools.messages.push_back({
                "tool",
            ...
            conversation_with_tools.messages.push_back(
                simple_assist_msg("CC", "Think last", "read_file",
                                  "{\"args\": [{\"path\": \"src/providers/ThemeProvider.tsx\"}, {\"path\": "
                                  "\"src/components/Header.tsx\"}, {\"path\": \"src/components/ThemeToggle.tsx\"}, "
                                  "{\"path\": \"src/app/globals.css\"}, {\"path\": \"src/app/layout.tsx\"}]}"));
            conversation_with_tools.messages.push_back({
            ...
            assert_equals(
                common_chat_templates_apply(tmpls.get(), conversation_with_tools).prompt,
                std::string(
                    "<|im_system|>tool_declare<|im_middle|>[{\"type\": \"function\", \"function\": {\"name\": "
                    "\"special_function\", \"description\": \"I'm special\", \"parameters\": {\"type\": \"object\", "
                    "\"properties\": {\"arg1\": {\"type\": \"integer\", \"description\": \"The arg.\"}}, \"required\": "
                    "[\"arg1\"]}}}]<|im_end|><|im_system|>system<|im_middle|>You are Kimi, an AI assistant created by "
                    "Moonshot AI.<|im_end|><|im_user|>user<|im_middle|>Hey "
                    "there!<|im_end|><|im_assistant|>assistant<|im_middle|><think>Think first</think>Let's do "
                    "it<|tool_calls_section_begin|><|tool_call_begin|>functions.complex_function:0<|tool_call_argument_"
                    "begin|>{\"name\":\"John "
                    "Doe\",\"age\":30,\"active\":true,\"score\":95.5}<|tool_call_end|><|tool_calls_section_end|><|im_"
                    "end|><|im_system|>complex_function<|im_middle|>## Return of functions.complex_function:0\nTool "
                    "response 1<|im_end|><|im_assistant|>assistant<|im_middle|><think>Think "
                    "next</"
                    "think>Continue<|tool_calls_section_begin|><|tool_call_begin|>functions.web_search:1<|tool_call_"
                    "argument_begin|>{\"query\":\"\\\"From Zero\\\" Linkin Park album tracklist complete "
                    "songs\",\"limit\":3,\"type\":\"text\"}<|tool_call_end|><|tool_calls_section_end|><|im_end|><|im_"
                    "system|>web_search<|im_middle|>## Return of functions.web_search:1\nTool response "
                    "2<|im_end|><|im_assistant|>assistant<|im_middle|><think>Think "
                    "last</"
                    "think>CC<|tool_calls_section_begin|><|tool_call_begin|>functions.read_file:2<|tool_call_argument_"
                    "begin|>{\"args\": [{\"path\": \"src/providers/ThemeProvider.tsx\"}, {\"path\": "
                    "\"src/components/Header.tsx\"}, {\"path\": \"src/components/ThemeToggle.tsx\"}, {\"path\": "
                    "\"src/app/globals.css\"}, {\"path\": "
                    "\"src/app/"
                    "layout.tsx\"}]}<|tool_call_end|><|tool_calls_section_end|><|im_end|><|im_system|>read_file<|im_"
                    "middle|>## Return of functions.read_file:2\nTool response "
                    "3<|im_end|><|im_assistant|>assistant<|im_middle|>"));
            ...
            test_templates(tmpls.get(), end_tokens, message_assist_call, tools,
                           "<think></"
                           "think><|tool_calls_section_begin|><|tool_call_begin|>functions.special_function:0<|tool_"
                           "call_argument_begin|>{\"arg1\": 1}<|tool_call_end|><|tool_calls_section_end|>",
                           /* expect_grammar_triggered= */ true,
                           /* test_grammar_if_triggered= */ true,
                           /* common_reasoning_format= */ COMMON_REASONING_FORMAT_DEEPSEEK,
            ...
            test_templates(tmpls.get(), end_tokens, message_assist_call_noopt, tools,
                           "<think></"
                           "think><|tool_calls_section_begin|><|tool_call_begin|>functions.special_function_with_opt:0<"
                           "|tool_call_argument_begin|>{\"arg1\": 1}<|tool_call_end|><|tool_calls_section_end|>",
                           /* expect_grammar_triggered= */ true,
                           /* test_grammar_if_triggered= */ true,
                           /* common_reasoning_format= */ COMMON_REASONING_FORMAT_DEEPSEEK,
            ...
            test_templates(
                tmpls.get(), end_tokens, message_assist_call_withopt, tools,
                "<think></"
                "think><|tool_calls_section_begin|><|tool_call_begin|>functions.special_function_with_opt:0<|tool_call_"
                "argument_begin|>{\"arg1\": 1, \"arg2\": 2}<|tool_call_end|><|tool_calls_section_end|>",
                /* expect_grammar_triggered= */ true,
                /* test_grammar_if_triggered= */ true,
                /* common_reasoning_format= */ COMMON_REASONING_FORMAT_DEEPSEEK,
        ...
        // Test Qwen3-Coder XML format
        {
            ...
            test_parser_with_streaming(expected_array_param,
                                       "<tool_call>\n"
            ...
            test_parser_with_streaming(expected_empty_param,
                                       "<tool_call>\n"
            ...
            test_parser_with_streaming(expected_boolean,
                                       "<tool_call>\n"
            ...
            test_parser_with_streaming(expected_null,
                                       "<tool_call>\n"
            ...
            test_parser_with_streaming(expected_numbers,
                                       "<tool_call>\n"
            ...
            test_parser_with_streaming(expected_xml_content,
                                       "<tool_call>\n"
            ...
            test_parser_with_streaming(expected_quotes,
                                       "<tool_call>\n"
            ...
            std::string long_text =
                "This is a long text parameter that should test the parser's ability to handle larger amounts of text "
                "data.";
            ...
            test_parser_with_streaming(expected_long_text,
                                       "<tool_call>\n"
            ...
            test_parser_with_streaming(expected_mixed_content,
            ...
            test_parser_with_streaming(
                ...
                [&](const std::string & msg) {
                    return common_chat_parse(msg, /* is_partial= */ true, { COMMON_CHAT_FORMAT_QWEN3_CODER_XML });
                });
            ...
            test_parser_with_streaming(expected_complex_name,
                                       "<tool_call>\n"
            ...
            test_parser_with_streaming(expected_complex_params,
                                       "<tool_call>\n"
            ...
            expected_deep_xml.tool_calls = {
                { "xml_parser",
                 "{\"xml\":\"<root><level1><level2><level3>deep content</level3></level2></level1></root>\"}", "" }
            };
            ...
            test_parser_with_streaming(expected_whitespace_param,
                                       "<tool_call>\n"
            ...
            test_parser_with_streaming(expected_mixed_whitespace,
                                       "<tool_call>\n"
            ...
            test_parser_with_streaming(expected_control_chars,
                                       "<tool_call>\n"
            ...
            test_parser_with_streaming(expected_emoji,
                                       "<tool_call>\n"
            ...
            test_parser_with_streaming(expected_math,
                                       "<tool_call>\n"
                                       "  <function=math_function>\n"
                                       "    <parameter=formula>\n"
            ...
            test_parser_with_streaming(expected_sql,
                                       "<tool_call>\n"
            ...
            test_parser_with_streaming(expected_html,
                                       "<tool_call>\n"
            ...
            test_parser_with_streaming(expected_large_numbers,
                                       "<tool_call>\n"
...
static void test_template_output_peg_parsers() {
...

    {
        ...
        // Test basic content without tags
        test_peg_parser(tmpls.get(), [&](auto & t) {
            t.input  = "Hello, world!\nWhat's up?";
            t.expect = message_assist;
        });

        // Test content with response tags
        test_peg_parser(tmpls.get(), [&](auto & t) {
            t.input  = "<|START_RESPONSE|>Hello, world!\nWhat's up?<|END_RESPONSE|>";
            t.expect = message_assist;
        });

        // Test thinking + content with reasoning_format = DEEPSEEK (parsed)
        test_peg_parser(tmpls.get(), [&](auto & t) {
            t.input =
        ...
        // Test thinking + tool call with reasoning_format = DEEPSEEK
        test_peg_parser(tmpls.get(), [&](auto & t) {
            t.input =
                "<|START_THINKING|>I'm\nthinking<|END_THINKING|>"
                "<|START_ACTION|>[\n"
        ...
        // Test partial tool call with thinking (name incomplete)
        test_peg_parser(tmpls.get(), [&](auto & t) {
            t.input =
                "<|START_THINKING|>I'm\nthinking<|END_THINKING|>"
                "<|START_ACTION|>[\n"
            ...
            t.params.tools            = { special_function_tool };
            t.is_partial              = true;
            t.expect                  = message_assist_thoughts_partial_call;
        });

        // Test tool call without thinking (empty thinking block)
        test_peg_parser(tmpls.get(), [&](auto & t) {
            t.input =
...

    {
        ...
        // Test basic content message (no tools)
        test_peg_parser(tmpls.get(), [&](auto & t) {
            t.input =
                "{\n"
                "  \"response\": \"Hello, world!\\nWhat's up?\"\n"
            ...
            t.expect = message_assist_json_content;
        });
        ...
        // Test partial tool call - name only
        test_peg_parser(tmpls.get(), [&](auto & t) {
        ...
        // Test partial tool call - name and partial arguments
        test_peg_parser(tmpls.get(), [&](auto & t) {
            t.input        = "{ \"tool_call\" : { \"name\" : \"special_function\", \"arguments\" : { \"arg";
            t.params.tools = { special_function_tool };
            t.expect       = message_assist_call_cutoff_args;
        });

        // Test partial tool call - different tool
        test_peg_parser(tmpls.get(), [&](auto & t) {
            t.input =
                R"({"tool_call": {"name": "puppeteer_screenshot", "arguments": {"name": "servethehome_homepage",)";
            t.params.tools = { special_function_tool };  // Note: different tool in params vs input
            t.expect       = simple_assist_msg("", "", "puppeteer_screenshot", "{\"name\":\"servethehome_homepage\",");
        });
    }

    {
        ...
        // Test basic thinking content
        test_peg_parser(tmpls.get(), [&](auto & t) {
            t.input                   = "<think>\nLet me think about this...\n</think>\nThe answer is 42.";
            t.params.reasoning_format = COMMON_REASONING_FORMAT_AUTO;
            t.expect                  = simple_assist_msg("The answer is 42.", "Let me think about this...");
        });
        ...
        test_peg_parser(tmpls.get(), [&](auto & t) {
            ...
            t.params.reasoning_format = COMMON_REASONING_FORMAT_AUTO;
            t.params.tools            = { special_function_tool };
            t.expect = simple_assist_msg("", "I should use a tool", "special_function", R"({"arg1": 1})");
        });
    }

    {
        ...
        // Test tool call with thinking (QwQ-style)
        test_peg_parser(tmpls.get(), [&](auto & t) {
            t.input =
                "I'm\nthinking</think>\n"
        ...
        test_peg_parser(tmpls.get(), [&](auto & t) {
            ...
            t.params.tools = { python_tool };
            t.expect       = simple_assist_msg("", "", "python", "");
        });

        // Test alternate formats - <function> syntax
        test_peg_parser(tmpls.get(), [&](auto & t) {
            t.input        = "<function=special_function>{\"arg1\": 1}</function>";
            t.params.tools = { special_function_tool };
            t.expect       = message_assist_call;
        });

        // Test alternate formats - ```json syntax
        test_peg_parser(tmpls.get(), [&](auto & t) {
            t.input =
                "```json\n"
                "{\"name\": \"special_function\", \"arguments\": {\"arg1\": 1}}\n"
    ...
    {
        // Functionary v3.1 (tool calling model)
...

    {
        ...
        test_peg_parser(tmpls.get(), [&](auto & t) {
            t.input =
                "<think>I'm\nthinking</think><|tool_call|>[{\"name\": \"special_function\", \"arguments\": {\"arg1\": "
                "1}}]";
            t.params.reasoning_format = COMMON_REASONING_FORMAT_DEEPSEEK;
            t.params.tools            = { special_function_tool };
            t.expect                  = message_assist_call_thoughts;
