...
struct llama_context_params {
    ...
    bool use_dsa;  // whether to use DeepSeek Sparse Attention (requires DSA weights in model)
...
enum llama_params_fit_status {
    ...
    LLAMA_PARAMS_FIT_STATUS_ERROR =
        2,  // a hard error occured, e.g. because no model could be found at the specified path
};
