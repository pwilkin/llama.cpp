...
common_params_context common_params_parser_init(common_params & params,
    ...
    add_opt(
        common_arg(
            ...
            .set_examples(
                { LLAMA_EXAMPLE_SERVER, LLAMA_EXAMPLE_PERPLEXITY, LLAMA_EXAMPLE_BATCHED, LLAMA_EXAMPLE_BENCH }));
    ...
    add_opt(common_arg({ "--dsa" }, { "--no-dsa" },
                       string_format("enable DeepSeek Sparse Attention (requires DSA weights in model) (default: %s)",
                                     params.use_dsa ? "true" : "false"),
                       [](common_params & params, bool value) { params.use_dsa = value; }));
