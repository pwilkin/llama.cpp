...
struct llama_layer {
    ...
    struct ggml_tensor * wq_idx_a = nullptr;  // Indexer query projection A: [n_embd, kv_lora_rank]
    struct ggml_tensor * wq_idx_b =
        nullptr;  // Indexer query projection B: [kv_lora_rank, n_dsa_indexer_heads * n_dsa_indexer_head_dim]
    struct ggml_tensor * dsa_idx_norm    = nullptr;  // Indexer layernorm: [kv_lora_rank]
    struct ggml_tensor * dsa_idx_weights = nullptr;  // Head weights for combining scores: [n_dsa_indexer_heads]
