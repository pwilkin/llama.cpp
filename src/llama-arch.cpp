...
static const std::map<llm_kv, const char *> LLM_KV_NAMES = {
    ...
    { LLM_KV_HC_MULT,                           "%s.hyperconnection.mult"              },
    { LLM_KV_HC_SINKHORN_ITERS,                 "%s.hyperconnection.sinkhorn_iters"    },
    { LLM_KV_HC_EPS,                            "%s.hyperconnection.eps"               },
...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_COMPRESSOR_KV,                          "blk.%d.compressor_kv" },
    { LLM_TENSOR_COMPRESSOR_GATE,                        "blk.%d.compressor_gate" },
    { LLM_TENSOR_COMPRESSOR_NORM,                        "blk.%d.compressor_norm" },
    { LLM_TENSOR_COMPRESSOR_APE,                         "blk.%d.compressor_ape" },
    { LLM_TENSOR_INDEXER_COMPRESSOR_KV,                  "blk.%d.indexer.compressor_kv" },
    { LLM_TENSOR_INDEXER_COMPRESSOR_GATE,                "blk.%d.indexer.compressor_gate" },
    { LLM_TENSOR_INDEXER_COMPRESSOR_NORM,                "blk.%d.indexer.compressor_norm" },
    { LLM_TENSOR_INDEXER_COMPRESSOR_APE,                 "blk.%d.indexer.compressor_ape" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_HC_HEAD_BASE,               {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_MUL}},
    ...
    {LLM_TENSOR_HC_ATTN_BASE,               {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    ...
    {LLM_TENSOR_HC_FFN_BASE,                {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    ...
    {LLM_TENSOR_COMPRESSOR_KV,              {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_COMPRESSOR_GATE,            {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
