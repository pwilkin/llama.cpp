...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_ATTN_Q_IDX_A,           "blk.%d.attn_q_idx_a"           }, // DSA indexer query projection A
    { LLM_TENSOR_ATTN_Q_IDX_B,           "blk.%d.attn_q_idx_b"           }, // DSA indexer query projection B
    { LLM_TENSOR_ATTN_Q_IDX_NORM,        "blk.%d.attn_q_idx_norm"        }, // DSA indexer layernorm
    { LLM_TENSOR_ATTN_DSA_IDX_WEIGHTS,   "blk.%d.dsa_idx_weights"        }, // DSA indexer head weights
...
static std::set<llm_tensor> llm_get_tensor_names(llm_arch arch) {
    switch (arch) {
        ...
        case LLM_ARCH_LLAMA_EMBED:
            return {
                LLM_TENSOR_TOKEN_EMBD,   LLM_TENSOR_OUTPUT_NORM,   LLM_TENSOR_OUTPUT,        LLM_TENSOR_ROPE_FREQS,
                LLM_TENSOR_ATTN_NORM,    LLM_TENSOR_ATTN_Q,        LLM_TENSOR_ATTN_K,        LLM_TENSOR_ATTN_V,
                LLM_TENSOR_ATTN_OUT,     LLM_TENSOR_ATTN_ROT_EMBD, LLM_TENSOR_FFN_GATE_INP,  LLM_TENSOR_FFN_NORM,
                LLM_TENSOR_FFN_GATE,     LLM_TENSOR_FFN_DOWN,      LLM_TENSOR_FFN_UP,        LLM_TENSOR_FFN_GATE_EXP,
                LLM_TENSOR_FFN_DOWN_EXP, LLM_TENSOR_FFN_UP_EXP,    LLM_TENSOR_FFN_GATE_EXPS, LLM_TENSOR_FFN_DOWN_EXPS,
        ...
        case LLM_ARCH_NEMOTRON:
            return {
                LLM_TENSOR_TOKEN_EMBD, LLM_TENSOR_OUTPUT_NORM,   LLM_TENSOR_OUTPUT,   LLM_TENSOR_ROPE_FREQS,
                LLM_TENSOR_ATTN_NORM,  LLM_TENSOR_ATTN_Q,        LLM_TENSOR_ATTN_K,   LLM_TENSOR_ATTN_V,
                LLM_TENSOR_ATTN_OUT,   LLM_TENSOR_ATTN_ROT_EMBD, LLM_TENSOR_FFN_NORM, LLM_TENSOR_FFN_DOWN,
                LLM_TENSOR_FFN_UP,
            };
        case LLM_ARCH_AFMOE:
            return {
                LLM_TENSOR_TOKEN_EMBD,      LLM_TENSOR_OUTPUT_NORM,    LLM_TENSOR_OUTPUT,
                LLM_TENSOR_ATTN_NORM,       LLM_TENSOR_ATTN_POST_NORM, LLM_TENSOR_ATTN_Q,
                LLM_TENSOR_ATTN_K,          LLM_TENSOR_ATTN_V,         LLM_TENSOR_ATTN_OUT,
                LLM_TENSOR_ATTN_Q_NORM,     LLM_TENSOR_ATTN_K_NORM,    LLM_TENSOR_ATTN_GATE,
                LLM_TENSOR_FFN_NORM,        LLM_TENSOR_FFN_POST_NORM,  LLM_TENSOR_FFN_GATE_INP,
                LLM_TENSOR_FFN_GATE,        LLM_TENSOR_FFN_DOWN,       LLM_TENSOR_FFN_UP,
                LLM_TENSOR_FFN_GATE_EXPS,   LLM_TENSOR_FFN_DOWN_EXPS,  LLM_TENSOR_FFN_UP_EXPS,
                LLM_TENSOR_FFN_GATE_SHEXP,  LLM_TENSOR_FFN_UP_SHEXP,   LLM_TENSOR_FFN_DOWN_SHEXP,
        ...
        case LLM_ARCH_LLAMA4:
            return {
                ...
                LLM_TENSOR_FFN_GATE,     LLM_TENSOR_FFN_DOWN,       LLM_TENSOR_FFN_UP,         LLM_TENSOR_FFN_GATE_EXP,
                LLM_TENSOR_FFN_DOWN_EXP, LLM_TENSOR_FFN_UP_EXP,     LLM_TENSOR_FFN_GATE_EXPS,  LLM_TENSOR_FFN_DOWN_EXPS,
                LLM_TENSOR_FFN_UP_EXPS,  LLM_TENSOR_FFN_GATE_SHEXP, LLM_TENSOR_FFN_DOWN_SHEXP, LLM_TENSOR_FFN_UP_SHEXP,
            };
        ...
        case LLM_ARCH_EXAONE:
            return {
                LLM_TENSOR_TOKEN_EMBD, LLM_TENSOR_OUTPUT_NORM,   LLM_TENSOR_OUTPUT,   LLM_TENSOR_ROPE_FREQS,
                LLM_TENSOR_ATTN_NORM,  LLM_TENSOR_ATTN_Q,        LLM_TENSOR_ATTN_K,   LLM_TENSOR_ATTN_V,
                LLM_TENSOR_ATTN_OUT,   LLM_TENSOR_ATTN_ROT_EMBD, LLM_TENSOR_FFN_NORM, LLM_TENSOR_FFN_GATE,
                LLM_TENSOR_FFN_DOWN,   LLM_TENSOR_FFN_UP,
            };
        case LLM_ARCH_FALCON:
            return {
                LLM_TENSOR_TOKEN_EMBD, LLM_TENSOR_OUTPUT_NORM, LLM_TENSOR_OUTPUT,
                LLM_TENSOR_ATTN_NORM,  LLM_TENSOR_ATTN_NORM_2, LLM_TENSOR_ATTN_QKV,
                LLM_TENSOR_ATTN_OUT,   LLM_TENSOR_FFN_DOWN,    LLM_TENSOR_FFN_UP,
            };
        case LLM_ARCH_GROK:
            return {
                LLM_TENSOR_TOKEN_EMBD,   LLM_TENSOR_OUTPUT_NORM,   LLM_TENSOR_OUTPUT,         LLM_TENSOR_ROPE_FREQS,
                ...
                LLM_TENSOR_FFN_GATE,     LLM_TENSOR_FFN_DOWN,      LLM_TENSOR_FFN_UP,         LLM_TENSOR_FFN_GATE_EXP,
                LLM_TENSOR_FFN_DOWN_EXP, LLM_TENSOR_FFN_UP_EXP,    LLM_TENSOR_FFN_GATE_EXPS,  LLM_TENSOR_FFN_DOWN_EXPS,
                LLM_TENSOR_FFN_UP_EXPS,  LLM_TENSOR_FFN_POST_NORM, LLM_TENSOR_LAYER_OUT_NORM, LLM_TENSOR_ATTN_OUT_NORM,
            };
        case LLM_ARCH_GPT2:
        case LLM_ARCH_STARCODER:
            return {
                LLM_TENSOR_TOKEN_EMBD, LLM_TENSOR_POS_EMBD, LLM_TENSOR_OUTPUT_NORM, LLM_TENSOR_OUTPUT,
                LLM_TENSOR_ATTN_NORM,  LLM_TENSOR_ATTN_QKV, LLM_TENSOR_ATTN_OUT,    LLM_TENSOR_FFN_NORM,
                LLM_TENSOR_FFN_UP,     LLM_TENSOR_FFN_DOWN,
            };
        case LLM_ARCH_GPTNEOX:
            return {
                LLM_TENSOR_TOKEN_EMBD, LLM_TENSOR_OUTPUT_NORM, LLM_TENSOR_OUTPUT,
                LLM_TENSOR_ATTN_NORM,  LLM_TENSOR_ATTN_QKV,    LLM_TENSOR_ATTN_OUT,
                LLM_TENSOR_FFN_NORM,   LLM_TENSOR_FFN_DOWN,    LLM_TENSOR_FFN_UP,
            };
        case LLM_ARCH_MPT:
            return {
                LLM_TENSOR_TOKEN_EMBD,  LLM_TENSOR_OUTPUT_NORM, LLM_TENSOR_OUTPUT,   LLM_TENSOR_ATTN_NORM,
                LLM_TENSOR_FFN_NORM,    LLM_TENSOR_ATTN_QKV,    LLM_TENSOR_ATTN_OUT, LLM_TENSOR_FFN_DOWN,
                LLM_TENSOR_FFN_UP,      LLM_TENSOR_FFN_ACT,     LLM_TENSOR_POS_EMBD, LLM_TENSOR_ATTN_Q_NORM,
        ...
        case LLM_ARCH_PANGU_EMBED:
            return {
                LLM_TENSOR_TOKEN_EMBD, LLM_TENSOR_OUTPUT_NORM, LLM_TENSOR_OUTPUT,   LLM_TENSOR_ATTN_NORM,
                LLM_TENSOR_ATTN_Q,     LLM_TENSOR_ATTN_K,      LLM_TENSOR_ATTN_V,   LLM_TENSOR_ATTN_OUT,
                LLM_TENSOR_FFN_NORM,   LLM_TENSOR_FFN_GATE,    LLM_TENSOR_FFN_DOWN, LLM_TENSOR_FFN_UP,
            };
        case LLM_ARCH_BERT:
            return {
                LLM_TENSOR_TOKEN_EMBD,     LLM_TENSOR_TOKEN_EMBD_NORM,
                LLM_TENSOR_TOKEN_TYPES,    LLM_TENSOR_POS_EMBD,
                LLM_TENSOR_ATTN_OUT_NORM,  LLM_TENSOR_ATTN_QKV,
                LLM_TENSOR_ATTN_Q,         LLM_TENSOR_ATTN_K,
                LLM_TENSOR_ATTN_V,         LLM_TENSOR_ATTN_OUT,
                LLM_TENSOR_LAYER_OUT_NORM, LLM_TENSOR_FFN_DOWN,
                LLM_TENSOR_FFN_UP,         LLM_TENSOR_CLS,
                LLM_TENSOR_CLS_OUT,
            };
        case LLM_ARCH_NOMIC_BERT:
            return {
                LLM_TENSOR_TOKEN_EMBD, LLM_TENSOR_TOKEN_EMBD_NORM, LLM_TENSOR_TOKEN_TYPES,    LLM_TENSOR_ATTN_OUT_NORM,
                LLM_TENSOR_ATTN_QKV,   LLM_TENSOR_ATTN_OUT,        LLM_TENSOR_LAYER_OUT_NORM, LLM_TENSOR_FFN_GATE,
                LLM_TENSOR_FFN_DOWN,   LLM_TENSOR_FFN_UP,
            };
        case LLM_ARCH_NOMIC_BERT_MOE:
            return {
                LLM_TENSOR_TOKEN_EMBD,  LLM_TENSOR_TOKEN_EMBD_NORM, LLM_TENSOR_TOKEN_TYPES,    LLM_TENSOR_ATTN_OUT_NORM,
                LLM_TENSOR_ATTN_QKV,    LLM_TENSOR_ATTN_OUT,        LLM_TENSOR_LAYER_OUT_NORM, LLM_TENSOR_FFN_GATE,
                LLM_TENSOR_FFN_DOWN,    LLM_TENSOR_FFN_UP,          LLM_TENSOR_FFN_GATE_INP,   LLM_TENSOR_FFN_DOWN_EXPS,
                LLM_TENSOR_FFN_UP_EXPS,
            };
        case LLM_ARCH_NEO_BERT:
            return {
                LLM_TENSOR_TOKEN_EMBD, LLM_TENSOR_ATTN_NORM, LLM_TENSOR_ATTN_QKV, LLM_TENSOR_ATTN_OUT,
                LLM_TENSOR_FFN_NORM,   LLM_TENSOR_FFN_DOWN,  LLM_TENSOR_FFN_UP,   LLM_TENSOR_ENC_OUTPUT_NORM,
                LLM_TENSOR_CLS,        LLM_TENSOR_CLS_OUT,
            };
        case LLM_ARCH_MODERN_BERT:
            return {
                LLM_TENSOR_TOKEN_EMBD, LLM_TENSOR_TOKEN_EMBD_NORM, LLM_TENSOR_OUTPUT_NORM,
                LLM_TENSOR_ATTN_NORM,  LLM_TENSOR_ATTN_OUT,        LLM_TENSOR_ATTN_QKV,
                LLM_TENSOR_FFN_DOWN,   LLM_TENSOR_FFN_UP,          LLM_TENSOR_FFN_NORM,
                LLM_TENSOR_CLS,        LLM_TENSOR_CLS_OUT,
            };
        case LLM_ARCH_JINA_BERT_V2:
            return {
                LLM_TENSOR_TOKEN_EMBD,    LLM_TENSOR_TOKEN_EMBD_NORM, LLM_TENSOR_TOKEN_TYPES, LLM_TENSOR_ATTN_NORM_2,
                LLM_TENSOR_ATTN_OUT_NORM, LLM_TENSOR_ATTN_Q,          LLM_TENSOR_ATTN_Q_NORM, LLM_TENSOR_ATTN_K,
                LLM_TENSOR_ATTN_K_NORM,   LLM_TENSOR_ATTN_V,          LLM_TENSOR_ATTN_OUT,    LLM_TENSOR_LAYER_OUT_NORM,
                LLM_TENSOR_FFN_DOWN,      LLM_TENSOR_FFN_GATE,        LLM_TENSOR_FFN_UP,      LLM_TENSOR_CLS,
            };
        case LLM_ARCH_JINA_BERT_V3:
            return {
                LLM_TENSOR_TOKEN_EMBD,    LLM_TENSOR_TOKEN_EMBD_NORM, LLM_TENSOR_TOKEN_TYPES,
                LLM_TENSOR_ATTN_OUT_NORM, LLM_TENSOR_ATTN_QKV,        LLM_TENSOR_ATTN_OUT,
                LLM_TENSOR_FFN_DOWN,      LLM_TENSOR_FFN_UP,          LLM_TENSOR_LAYER_OUT_NORM,
            };
        case LLM_ARCH_BLOOM:
            return {
        ...
        case LLM_ARCH_STABLELM:
            return {
                LLM_TENSOR_TOKEN_EMBD, LLM_TENSOR_OUTPUT_NORM, LLM_TENSOR_OUTPUT,      LLM_TENSOR_ROPE_FREQS,
                LLM_TENSOR_ATTN_NORM,  LLM_TENSOR_ATTN_Q,      LLM_TENSOR_ATTN_K,      LLM_TENSOR_ATTN_V,
                LLM_TENSOR_ATTN_OUT,   LLM_TENSOR_FFN_NORM,    LLM_TENSOR_FFN_GATE,    LLM_TENSOR_FFN_DOWN,
                LLM_TENSOR_FFN_UP,     LLM_TENSOR_ATTN_Q_NORM, LLM_TENSOR_ATTN_K_NORM,
            };
        case LLM_ARCH_QWEN:
            return {
                LLM_TENSOR_TOKEN_EMBD, LLM_TENSOR_OUTPUT_NORM, LLM_TENSOR_OUTPUT,   LLM_TENSOR_ROPE_FREQS,
        ...
        case LLM_ARCH_QWEN2MOE:
            return {
                LLM_TENSOR_TOKEN_EMBD,     LLM_TENSOR_OUTPUT_NORM,
                LLM_TENSOR_OUTPUT,         LLM_TENSOR_ATTN_NORM,
                LLM_TENSOR_ATTN_Q,         LLM_TENSOR_ATTN_K,
                LLM_TENSOR_ATTN_V,         LLM_TENSOR_ATTN_OUT,
                LLM_TENSOR_FFN_NORM,       LLM_TENSOR_FFN_GATE_INP,
                LLM_TENSOR_FFN_GATE_EXPS,  LLM_TENSOR_FFN_DOWN_EXPS,
                LLM_TENSOR_FFN_UP_EXPS,    LLM_TENSOR_FFN_GATE_INP_SHEXP,
                LLM_TENSOR_FFN_GATE_SHEXP, LLM_TENSOR_FFN_DOWN_SHEXP,
                LLM_TENSOR_FFN_UP_SHEXP,
            };
        case LLM_ARCH_QWEN3:
            return {
                LLM_TENSOR_TOKEN_EMBD,  LLM_TENSOR_OUTPUT_NORM, LLM_TENSOR_OUTPUT,      LLM_TENSOR_CLS_OUT,
                LLM_TENSOR_ATTN_NORM,   LLM_TENSOR_ATTN_Q,      LLM_TENSOR_ATTN_Q_NORM, LLM_TENSOR_ATTN_K,
                LLM_TENSOR_ATTN_K_NORM, LLM_TENSOR_ATTN_V,      LLM_TENSOR_ATTN_OUT,    LLM_TENSOR_FFN_NORM,
                LLM_TENSOR_FFN_GATE,    LLM_TENSOR_FFN_DOWN,    LLM_TENSOR_FFN_UP,
            };
        ...
        case LLM_ARCH_RND1:
            return {
                LLM_TENSOR_TOKEN_EMBD,    LLM_TENSOR_OUTPUT_NORM,   LLM_TENSOR_OUTPUT,      LLM_TENSOR_ATTN_NORM,
                LLM_TENSOR_ATTN_Q,        LLM_TENSOR_ATTN_Q_NORM,   LLM_TENSOR_ATTN_K,      LLM_TENSOR_ATTN_K_NORM,
                LLM_TENSOR_ATTN_V,        LLM_TENSOR_ATTN_OUT,      LLM_TENSOR_FFN_NORM,    LLM_TENSOR_FFN_GATE_INP,
                LLM_TENSOR_FFN_GATE_EXPS, LLM_TENSOR_FFN_DOWN_EXPS, LLM_TENSOR_FFN_UP_EXPS,
            };
        case LLM_ARCH_QWEN3NEXT:
            return {
                LLM_TENSOR_TOKEN_EMBD,     LLM_TENSOR_OUTPUT_NORM,    LLM_TENSOR_OUTPUT,
                LLM_TENSOR_ATTN_NORM,      LLM_TENSOR_ATTN_POST_NORM, LLM_TENSOR_ATTN_Q,
                LLM_TENSOR_ATTN_Q_NORM,    LLM_TENSOR_ATTN_K,         LLM_TENSOR_ATTN_K_NORM,
                LLM_TENSOR_ATTN_V,         LLM_TENSOR_ATTN_OUT,       LLM_TENSOR_ATTN_QKV,
                LLM_TENSOR_ATTN_GATE,      LLM_TENSOR_FFN_GATE_INP,   LLM_TENSOR_FFN_GATE_EXPS,
                LLM_TENSOR_FFN_DOWN_EXPS,  LLM_TENSOR_FFN_UP_EXPS,    LLM_TENSOR_FFN_GATE_INP_SHEXP,
                LLM_TENSOR_FFN_GATE_SHEXP, LLM_TENSOR_FFN_DOWN_SHEXP, LLM_TENSOR_FFN_UP_SHEXP,
                LLM_TENSOR_SSM_A_NOSCAN,   LLM_TENSOR_SSM_CONV1D,     LLM_TENSOR_SSM_DT,
                LLM_TENSOR_SSM_BETA_ALPHA, LLM_TENSOR_SSM_IN,         LLM_TENSOR_SSM_NORM,
                LLM_TENSOR_SSM_OUT,
            };
        case LLM_ARCH_QWEN35:
            return {
                LLM_TENSOR_TOKEN_EMBD,     LLM_TENSOR_OUTPUT_NORM, LLM_TENSOR_OUTPUT,      LLM_TENSOR_ATTN_NORM,
                LLM_TENSOR_ATTN_POST_NORM, LLM_TENSOR_ATTN_Q,      LLM_TENSOR_ATTN_Q_NORM, LLM_TENSOR_ATTN_K,
                LLM_TENSOR_ATTN_K_NORM,    LLM_TENSOR_ATTN_V,      LLM_TENSOR_ATTN_OUT,    LLM_TENSOR_ATTN_QKV,
                LLM_TENSOR_ATTN_GATE,      LLM_TENSOR_FFN_GATE,    LLM_TENSOR_FFN_DOWN,    LLM_TENSOR_FFN_UP,
                LLM_TENSOR_SSM_A_NOSCAN,   LLM_TENSOR_SSM_CONV1D,  LLM_TENSOR_SSM_DT,      LLM_TENSOR_SSM_BETA,
                LLM_TENSOR_SSM_ALPHA,      LLM_TENSOR_SSM_NORM,    LLM_TENSOR_SSM_OUT,
            };
        case LLM_ARCH_QWEN35MOE:
            return {
                ...
                LLM_TENSOR_FFN_GATE_SHEXP, LLM_TENSOR_FFN_DOWN_SHEXP, LLM_TENSOR_FFN_UP_SHEXP,
                LLM_TENSOR_SSM_A_NOSCAN,   LLM_TENSOR_SSM_CONV1D,     LLM_TENSOR_SSM_DT,
                LLM_TENSOR_SSM_BETA,       LLM_TENSOR_SSM_ALPHA,      LLM_TENSOR_SSM_NORM,
                LLM_TENSOR_SSM_OUT,
            };
        ...
        case LLM_ARCH_HUNYUAN_DENSE:
            return {
                LLM_TENSOR_TOKEN_EMBD, LLM_TENSOR_OUTPUT_NORM, LLM_TENSOR_OUTPUT,   LLM_TENSOR_ATTN_NORM,
                LLM_TENSOR_ATTN_Q,     LLM_TENSOR_ATTN_Q_NORM, LLM_TENSOR_ATTN_K,   LLM_TENSOR_ATTN_K_NORM,
                LLM_TENSOR_ATTN_V,     LLM_TENSOR_ATTN_OUT,    LLM_TENSOR_FFN_NORM, LLM_TENSOR_FFN_GATE,
                LLM_TENSOR_FFN_DOWN,   LLM_TENSOR_FFN_UP,
            };
        case LLM_ARCH_PHI2:
            return {
        ...
        case LLM_ARCH_PLAMO:
            return {
                LLM_TENSOR_TOKEN_EMBD, LLM_TENSOR_OUTPUT_NORM,   LLM_TENSOR_OUTPUT,   LLM_TENSOR_ROPE_FREQS,
                LLM_TENSOR_ATTN_NORM,  LLM_TENSOR_ATTN_Q,        LLM_TENSOR_ATTN_K,   LLM_TENSOR_ATTN_V,
                LLM_TENSOR_ATTN_OUT,   LLM_TENSOR_ATTN_ROT_EMBD, LLM_TENSOR_FFN_GATE, LLM_TENSOR_FFN_DOWN,
                LLM_TENSOR_FFN_UP,
            };
        case LLM_ARCH_PLAMO2:
            return {
                LLM_TENSOR_TOKEN_EMBD,    LLM_TENSOR_OUTPUT_NORM,   LLM_TENSOR_OUTPUT,      LLM_TENSOR_ROPE_FREQS,
                LLM_TENSOR_ATTN_NORM,     LLM_TENSOR_ATTN_QKV,      LLM_TENSOR_ATTN_Q_NORM, LLM_TENSOR_ATTN_K_NORM,
                LLM_TENSOR_ATTN_OUT,      LLM_TENSOR_ATTN_ROT_EMBD, LLM_TENSOR_FFN_NORM,    LLM_TENSOR_FFN_DOWN,
                LLM_TENSOR_FFN_UP,        LLM_TENSOR_SSM_IN,        LLM_TENSOR_SSM_CONV1D,  LLM_TENSOR_SSM_X,
                LLM_TENSOR_SSM_DT,        LLM_TENSOR_SSM_A,         LLM_TENSOR_SSM_D,       LLM_TENSOR_SSM_OUT,
                LLM_TENSOR_SSM_DT_NORM,   LLM_TENSOR_SSM_B_NORM,    LLM_TENSOR_SSM_C_NORM,  LLM_TENSOR_ATTN_POST_NORM,
                LLM_TENSOR_FFN_POST_NORM,
            };
        case LLM_ARCH_PLAMO3:
            return {
                LLM_TENSOR_TOKEN_EMBD,     LLM_TENSOR_OUTPUT_NORM, LLM_TENSOR_OUTPUT,        LLM_TENSOR_ATTN_NORM,
                LLM_TENSOR_ATTN_QKV,       LLM_TENSOR_ATTN_Q_NORM, LLM_TENSOR_ATTN_K_NORM,   LLM_TENSOR_ATTN_OUT,
                LLM_TENSOR_ATTN_POST_NORM, LLM_TENSOR_FFN_NORM,    LLM_TENSOR_FFN_POST_NORM, LLM_TENSOR_FFN_DOWN,
                LLM_TENSOR_FFN_UP,
            };
        case LLM_ARCH_CODESHELL:
            return {
                LLM_TENSOR_TOKEN_EMBD, LLM_TENSOR_OUTPUT_NORM, LLM_TENSOR_OUTPUT,        LLM_TENSOR_ROPE_FREQS,
                LLM_TENSOR_ATTN_NORM,  LLM_TENSOR_ATTN_Q,      LLM_TENSOR_ATTN_K,        LLM_TENSOR_ATTN_V,
                LLM_TENSOR_ATTN_QKV,   LLM_TENSOR_ATTN_OUT,    LLM_TENSOR_ATTN_ROT_EMBD, LLM_TENSOR_FFN_NORM,
                LLM_TENSOR_FFN_GATE,   LLM_TENSOR_FFN_DOWN,    LLM_TENSOR_FFN_UP,
            };
        ...
        case LLM_ARCH_GEMMA:
            return {
                LLM_TENSOR_TOKEN_EMBD, LLM_TENSOR_OUTPUT_NORM, LLM_TENSOR_ATTN_NORM, LLM_TENSOR_ATTN_Q,
                LLM_TENSOR_ATTN_K,     LLM_TENSOR_ATTN_V,      LLM_TENSOR_ATTN_OUT,  LLM_TENSOR_FFN_NORM,
                LLM_TENSOR_FFN_GATE,   LLM_TENSOR_FFN_DOWN,    LLM_TENSOR_FFN_UP,
            };
        case LLM_ARCH_GEMMA2:
            return {
                LLM_TENSOR_TOKEN_EMBD,    LLM_TENSOR_OUTPUT_NORM, LLM_TENSOR_ATTN_NORM, LLM_TENSOR_ATTN_Q,
                LLM_TENSOR_ATTN_K,        LLM_TENSOR_ATTN_V,      LLM_TENSOR_ATTN_OUT,  LLM_TENSOR_ATTN_POST_NORM,
                LLM_TENSOR_FFN_NORM,      LLM_TENSOR_FFN_GATE,    LLM_TENSOR_FFN_DOWN,  LLM_TENSOR_FFN_UP,
                LLM_TENSOR_FFN_POST_NORM,
            };
        case LLM_ARCH_GEMMA3:
            return {
                LLM_TENSOR_TOKEN_EMBD, LLM_TENSOR_OUTPUT_NORM, LLM_TENSOR_OUTPUT,         LLM_TENSOR_ATTN_NORM,
                LLM_TENSOR_ATTN_Q,     LLM_TENSOR_ATTN_Q_NORM, LLM_TENSOR_ATTN_K,         LLM_TENSOR_ATTN_K_NORM,
                LLM_TENSOR_ATTN_V,     LLM_TENSOR_ATTN_OUT,    LLM_TENSOR_ATTN_POST_NORM, LLM_TENSOR_FFN_NORM,
                LLM_TENSOR_FFN_GATE,   LLM_TENSOR_FFN_DOWN,    LLM_TENSOR_FFN_UP,         LLM_TENSOR_FFN_POST_NORM,
            };
        ...
        case LLM_ARCH_GEMMA_EMBEDDING:
            return {
                LLM_TENSOR_TOKEN_EMBD,     LLM_TENSOR_OUTPUT_NORM,   LLM_TENSOR_OUTPUT,   LLM_TENSOR_DENSE_2_OUT,
                LLM_TENSOR_DENSE_3_OUT,    LLM_TENSOR_ATTN_NORM,     LLM_TENSOR_ATTN_Q,   LLM_TENSOR_ATTN_Q_NORM,
                LLM_TENSOR_ATTN_K,         LLM_TENSOR_ATTN_K_NORM,   LLM_TENSOR_ATTN_V,   LLM_TENSOR_ATTN_OUT,
                LLM_TENSOR_ATTN_POST_NORM, LLM_TENSOR_FFN_NORM,      LLM_TENSOR_FFN_GATE, LLM_TENSOR_FFN_DOWN,
                LLM_TENSOR_FFN_UP,         LLM_TENSOR_FFN_POST_NORM,
            };
        case LLM_ARCH_MAMBA:
            return {
                LLM_TENSOR_TOKEN_EMBD, LLM_TENSOR_OUTPUT_NORM, LLM_TENSOR_OUTPUT,  LLM_TENSOR_ATTN_NORM,
                LLM_TENSOR_SSM_IN,     LLM_TENSOR_SSM_CONV1D,  LLM_TENSOR_SSM_X,   LLM_TENSOR_SSM_DT,
                LLM_TENSOR_SSM_A,      LLM_TENSOR_SSM_D,       LLM_TENSOR_SSM_OUT,
            };
        case LLM_ARCH_MAMBA2:
            return {
                LLM_TENSOR_TOKEN_EMBD, LLM_TENSOR_OUTPUT_NORM, LLM_TENSOR_OUTPUT,  LLM_TENSOR_ATTN_NORM,
                LLM_TENSOR_SSM_IN,     LLM_TENSOR_SSM_CONV1D,  LLM_TENSOR_SSM_DT,  LLM_TENSOR_SSM_A,
                LLM_TENSOR_SSM_D,      LLM_TENSOR_SSM_NORM,    LLM_TENSOR_SSM_OUT,
            };
        case LLM_ARCH_JAMBA:
            return {
                LLM_TENSOR_TOKEN_EMBD,    LLM_TENSOR_OUTPUT_NORM, LLM_TENSOR_OUTPUT,       LLM_TENSOR_ATTN_NORM,
                LLM_TENSOR_SSM_IN,        LLM_TENSOR_SSM_CONV1D,  LLM_TENSOR_SSM_X,        LLM_TENSOR_SSM_DT,
                LLM_TENSOR_SSM_DT_NORM,   LLM_TENSOR_SSM_A,       LLM_TENSOR_SSM_B_NORM,   LLM_TENSOR_SSM_C_NORM,
                LLM_TENSOR_SSM_D,         LLM_TENSOR_SSM_OUT,     LLM_TENSOR_ATTN_Q,       LLM_TENSOR_ATTN_K,
                LLM_TENSOR_ATTN_V,        LLM_TENSOR_ATTN_OUT,    LLM_TENSOR_FFN_GATE_INP, LLM_TENSOR_FFN_NORM,
                LLM_TENSOR_FFN_GATE,      LLM_TENSOR_FFN_DOWN,    LLM_TENSOR_FFN_UP,       LLM_TENSOR_FFN_GATE_EXPS,
                LLM_TENSOR_FFN_DOWN_EXPS, LLM_TENSOR_FFN_UP_EXPS,
            };
        case LLM_ARCH_FALCON_H1:
            return {
                LLM_TENSOR_TOKEN_EMBD, LLM_TENSOR_OUTPUT,     LLM_TENSOR_OUTPUT_NORM, LLM_TENSOR_ATTN_NORM,
                LLM_TENSOR_ATTN_Q,     LLM_TENSOR_ATTN_K,     LLM_TENSOR_ATTN_V,      LLM_TENSOR_ATTN_OUT,
                LLM_TENSOR_SSM_IN,     LLM_TENSOR_SSM_CONV1D, LLM_TENSOR_SSM_DT,      LLM_TENSOR_SSM_A,
                LLM_TENSOR_SSM_D,      LLM_TENSOR_SSM_NORM,   LLM_TENSOR_SSM_OUT,     LLM_TENSOR_FFN_NORM,
                LLM_TENSOR_FFN_GATE,   LLM_TENSOR_FFN_DOWN,   LLM_TENSOR_FFN_UP,
            };
        case LLM_ARCH_COMMAND_R:
            return {
                LLM_TENSOR_TOKEN_EMBD, LLM_TENSOR_OUTPUT_NORM, LLM_TENSOR_ATTN_NORM,   LLM_TENSOR_ATTN_Q,
                LLM_TENSOR_ATTN_K,     LLM_TENSOR_ATTN_V,      LLM_TENSOR_ATTN_OUT,    LLM_TENSOR_FFN_GATE,
                LLM_TENSOR_FFN_DOWN,   LLM_TENSOR_FFN_UP,      LLM_TENSOR_ATTN_Q_NORM, LLM_TENSOR_ATTN_K_NORM,
            };
        ...
        case LLM_ARCH_DBRX:
            return {
                LLM_TENSOR_TOKEN_EMBD,    LLM_TENSOR_OUTPUT_NORM,   LLM_TENSOR_OUTPUT,        LLM_TENSOR_ATTN_QKV,
                LLM_TENSOR_ATTN_NORM,     LLM_TENSOR_ATTN_OUT,      LLM_TENSOR_ATTN_OUT_NORM, LLM_TENSOR_FFN_GATE_INP,
                LLM_TENSOR_FFN_GATE_EXPS, LLM_TENSOR_FFN_DOWN_EXPS, LLM_TENSOR_FFN_UP_EXPS,
            };
        case LLM_ARCH_OLMO:
            return {
                LLM_TENSOR_TOKEN_EMBD, LLM_TENSOR_OUTPUT,   LLM_TENSOR_ATTN_Q,   LLM_TENSOR_ATTN_K, LLM_TENSOR_ATTN_V,
                LLM_TENSOR_ATTN_OUT,   LLM_TENSOR_FFN_GATE, LLM_TENSOR_FFN_DOWN, LLM_TENSOR_FFN_UP,
            };
        case LLM_ARCH_OLMO2:
            return {
                LLM_TENSOR_TOKEN_EMBD,  LLM_TENSOR_OUTPUT_NORM, LLM_TENSOR_OUTPUT,        LLM_TENSOR_ATTN_Q,
                LLM_TENSOR_ATTN_K,      LLM_TENSOR_ATTN_V,      LLM_TENSOR_ATTN_OUT,      LLM_TENSOR_ATTN_POST_NORM,
                LLM_TENSOR_ATTN_Q_NORM, LLM_TENSOR_ATTN_K_NORM, LLM_TENSOR_FFN_POST_NORM, LLM_TENSOR_FFN_GATE,
                LLM_TENSOR_FFN_DOWN,    LLM_TENSOR_FFN_UP,
            };
        case LLM_ARCH_OPENELM:
            return {
                LLM_TENSOR_TOKEN_EMBD,  LLM_TENSOR_OUTPUT_NORM, LLM_TENSOR_ATTN_NORM, LLM_TENSOR_ATTN_QKV,
                LLM_TENSOR_ATTN_Q_NORM, LLM_TENSOR_ATTN_K_NORM, LLM_TENSOR_ATTN_OUT,  LLM_TENSOR_FFN_NORM,
                LLM_TENSOR_FFN_GATE,    LLM_TENSOR_FFN_DOWN,    LLM_TENSOR_FFN_UP,
            };
        case LLM_ARCH_ARCTIC:
            return {
                LLM_TENSOR_TOKEN_EMBD,   LLM_TENSOR_OUTPUT_NORM,   LLM_TENSOR_OUTPUT,        LLM_TENSOR_ATTN_NORM,
                LLM_TENSOR_ATTN_Q,       LLM_TENSOR_ATTN_K,        LLM_TENSOR_ATTN_V,        LLM_TENSOR_ATTN_OUT,
                LLM_TENSOR_FFN_GATE_INP, LLM_TENSOR_FFN_NORM,      LLM_TENSOR_FFN_GATE,      LLM_TENSOR_FFN_DOWN,
                LLM_TENSOR_FFN_UP,       LLM_TENSOR_FFN_NORM_EXPS, LLM_TENSOR_FFN_GATE_EXPS, LLM_TENSOR_FFN_DOWN_EXPS,
                LLM_TENSOR_FFN_UP_EXPS,
            };
        ...
        case LLM_ARCH_PLM:
            return {
                LLM_TENSOR_TOKEN_EMBD,    LLM_TENSOR_OUTPUT_NORM,    LLM_TENSOR_ATTN_NORM, LLM_TENSOR_ATTN_Q,
                LLM_TENSOR_ATTN_KV_A_MQA, LLM_TENSOR_ATTN_KV_A_NORM, LLM_TENSOR_ATTN_KV_B, LLM_TENSOR_ATTN_OUT,
                LLM_TENSOR_FFN_NORM,      LLM_TENSOR_FFN_DOWN,       LLM_TENSOR_FFN_UP,
            };
        case LLM_ARCH_CHATGLM:
            return {
                LLM_TENSOR_TOKEN_EMBD, LLM_TENSOR_ROPE_FREQS, LLM_TENSOR_OUTPUT_NORM, LLM_TENSOR_OUTPUT,
                LLM_TENSOR_ATTN_NORM,  LLM_TENSOR_ATTN_QKV,   LLM_TENSOR_ATTN_Q,      LLM_TENSOR_ATTN_K,
                LLM_TENSOR_ATTN_V,     LLM_TENSOR_ATTN_OUT,   LLM_TENSOR_FFN_NORM,    LLM_TENSOR_FFN_UP,
                LLM_TENSOR_FFN_DOWN,
            };
        case LLM_ARCH_GLM4:
            return {
                LLM_TENSOR_TOKEN_EMBD,     LLM_TENSOR_ROPE_FREQS,    LLM_TENSOR_OUTPUT_NORM, LLM_TENSOR_OUTPUT,
                LLM_TENSOR_ATTN_NORM,      LLM_TENSOR_ATTN_Q,        LLM_TENSOR_ATTN_K,      LLM_TENSOR_ATTN_V,
                LLM_TENSOR_ATTN_OUT,       LLM_TENSOR_FFN_NORM,      LLM_TENSOR_FFN_UP,      LLM_TENSOR_FFN_DOWN,
                LLM_TENSOR_ATTN_POST_NORM, LLM_TENSOR_FFN_POST_NORM,
            };
        ...
        case LLM_ARCH_BITNET:
            return {
                LLM_TENSOR_TOKEN_EMBD,   LLM_TENSOR_OUTPUT_NORM, LLM_TENSOR_ATTN_Q,    LLM_TENSOR_ATTN_K,
                LLM_TENSOR_ATTN_V,       LLM_TENSOR_ATTN_OUT,    LLM_TENSOR_ATTN_NORM, LLM_TENSOR_ATTN_SUB_NORM,
                LLM_TENSOR_FFN_GATE,     LLM_TENSOR_FFN_DOWN,    LLM_TENSOR_FFN_UP,    LLM_TENSOR_FFN_NORM,
                LLM_TENSOR_FFN_SUB_NORM,
            };
        case LLM_ARCH_T5:
            return {
                LLM_TENSOR_TOKEN_EMBD,           LLM_TENSOR_OUTPUT,
                LLM_TENSOR_DEC_OUTPUT_NORM,      LLM_TENSOR_DEC_ATTN_NORM,
                LLM_TENSOR_DEC_ATTN_Q,           LLM_TENSOR_DEC_ATTN_K,
                LLM_TENSOR_DEC_ATTN_V,           LLM_TENSOR_DEC_ATTN_OUT,
                LLM_TENSOR_DEC_ATTN_REL_B,       LLM_TENSOR_DEC_CROSS_ATTN_NORM,
                LLM_TENSOR_DEC_CROSS_ATTN_Q,     LLM_TENSOR_DEC_CROSS_ATTN_K,
                LLM_TENSOR_DEC_CROSS_ATTN_V,     LLM_TENSOR_DEC_CROSS_ATTN_OUT,
                LLM_TENSOR_DEC_CROSS_ATTN_REL_B, LLM_TENSOR_DEC_FFN_NORM,
                LLM_TENSOR_DEC_FFN_GATE,         LLM_TENSOR_DEC_FFN_DOWN,
                LLM_TENSOR_DEC_FFN_UP,           LLM_TENSOR_ENC_OUTPUT_NORM,
                LLM_TENSOR_ENC_ATTN_NORM,        LLM_TENSOR_ENC_ATTN_Q,
                LLM_TENSOR_ENC_ATTN_K,           LLM_TENSOR_ENC_ATTN_V,
                LLM_TENSOR_ENC_ATTN_OUT,         LLM_TENSOR_ENC_ATTN_REL_B,
                LLM_TENSOR_ENC_FFN_NORM,         LLM_TENSOR_ENC_FFN_GATE,
                LLM_TENSOR_ENC_FFN_DOWN,         LLM_TENSOR_ENC_FFN_UP,
            };
        case LLM_ARCH_T5ENCODER:
            return {
                LLM_TENSOR_TOKEN_EMBD,    LLM_TENSOR_OUTPUT,       LLM_TENSOR_ENC_OUTPUT_NORM,
                LLM_TENSOR_ENC_ATTN_NORM, LLM_TENSOR_ENC_ATTN_Q,   LLM_TENSOR_ENC_ATTN_K,
                LLM_TENSOR_ENC_ATTN_V,    LLM_TENSOR_ENC_ATTN_OUT, LLM_TENSOR_ENC_ATTN_REL_B,
                LLM_TENSOR_ENC_FFN_NORM,  LLM_TENSOR_ENC_FFN_GATE, LLM_TENSOR_ENC_FFN_DOWN,
                LLM_TENSOR_ENC_FFN_UP,
            };
        case LLM_ARCH_JAIS:
            return {
                LLM_TENSOR_TOKEN_EMBD, LLM_TENSOR_OUTPUT_NORM, LLM_TENSOR_OUTPUT,   LLM_TENSOR_ATTN_NORM,
                LLM_TENSOR_ATTN_QKV,   LLM_TENSOR_ATTN_OUT,    LLM_TENSOR_FFN_NORM, LLM_TENSOR_FFN_UP,
                LLM_TENSOR_FFN_GATE,   LLM_TENSOR_FFN_DOWN,
            };
        case LLM_ARCH_NEMOTRON_H:
            return {
                LLM_TENSOR_TOKEN_EMBD, LLM_TENSOR_OUTPUT_NORM, LLM_TENSOR_OUTPUT,   LLM_TENSOR_ATTN_NORM,
                LLM_TENSOR_SSM_IN,     LLM_TENSOR_SSM_CONV1D,  LLM_TENSOR_SSM_DT,   LLM_TENSOR_SSM_A,
                LLM_TENSOR_SSM_D,      LLM_TENSOR_SSM_NORM,    LLM_TENSOR_SSM_OUT,  LLM_TENSOR_ATTN_Q,
                LLM_TENSOR_ATTN_K,     LLM_TENSOR_ATTN_V,      LLM_TENSOR_ATTN_OUT, LLM_TENSOR_FFN_DOWN,
                LLM_TENSOR_FFN_UP,
            };
        ...
        case LLM_ARCH_EXAONE4:
            return {
                LLM_TENSOR_TOKEN_EMBD, LLM_TENSOR_OUTPUT_NORM, LLM_TENSOR_OUTPUT,         LLM_TENSOR_ROPE_FREQS,
                LLM_TENSOR_ATTN_Q,     LLM_TENSOR_ATTN_Q_NORM, LLM_TENSOR_ATTN_K,         LLM_TENSOR_ATTN_K_NORM,
                LLM_TENSOR_ATTN_V,     LLM_TENSOR_ATTN_OUT,    LLM_TENSOR_ATTN_POST_NORM, LLM_TENSOR_FFN_GATE,
                LLM_TENSOR_FFN_DOWN,   LLM_TENSOR_FFN_UP,      LLM_TENSOR_FFN_POST_NORM,
            };
        ...
        case LLM_ARCH_RWKV6:
            return {
                LLM_TENSOR_TOKEN_EMBD,          LLM_TENSOR_TOKEN_EMBD_NORM,
                LLM_TENSOR_OUTPUT_NORM,         LLM_TENSOR_OUTPUT,
                LLM_TENSOR_ATTN_NORM,           LLM_TENSOR_ATTN_NORM_2,
                LLM_TENSOR_TIME_MIX_W1,         LLM_TENSOR_TIME_MIX_W2,
                LLM_TENSOR_TIME_MIX_LERP_X,     LLM_TENSOR_TIME_MIX_LERP_W,
                LLM_TENSOR_TIME_MIX_LERP_K,     LLM_TENSOR_TIME_MIX_LERP_V,
                LLM_TENSOR_TIME_MIX_LERP_R,     LLM_TENSOR_TIME_MIX_LERP_G,
                LLM_TENSOR_TIME_MIX_LERP_FUSED, LLM_TENSOR_TIME_MIX_FIRST,
                LLM_TENSOR_TIME_MIX_DECAY,      LLM_TENSOR_TIME_MIX_DECAY_W1,
                LLM_TENSOR_TIME_MIX_DECAY_W2,   LLM_TENSOR_TIME_MIX_KEY,
                LLM_TENSOR_TIME_MIX_VALUE,      LLM_TENSOR_TIME_MIX_RECEPTANCE,
                LLM_TENSOR_TIME_MIX_GATE,       LLM_TENSOR_TIME_MIX_LN,
                LLM_TENSOR_TIME_MIX_OUTPUT,     LLM_TENSOR_CHANNEL_MIX_LERP_K,
                LLM_TENSOR_CHANNEL_MIX_LERP_R,  LLM_TENSOR_CHANNEL_MIX_KEY,
                LLM_TENSOR_CHANNEL_MIX_VALUE,   LLM_TENSOR_CHANNEL_MIX_RECEPTANCE,
            };
        ...
        case LLM_ARCH_RWKV7:
            return {
                LLM_TENSOR_TOKEN_EMBD,      LLM_TENSOR_TOKEN_EMBD_NORM,   LLM_TENSOR_OUTPUT_NORM,
                LLM_TENSOR_OUTPUT,          LLM_TENSOR_ATTN_NORM,         LLM_TENSOR_ATTN_NORM_2,
                LLM_TENSOR_TIME_MIX_W0,     LLM_TENSOR_TIME_MIX_W1,       LLM_TENSOR_TIME_MIX_W2,
                LLM_TENSOR_TIME_MIX_A0,     LLM_TENSOR_TIME_MIX_A1,       LLM_TENSOR_TIME_MIX_A2,
                LLM_TENSOR_TIME_MIX_V0,     LLM_TENSOR_TIME_MIX_V1,       LLM_TENSOR_TIME_MIX_V2,
                LLM_TENSOR_TIME_MIX_G1,     LLM_TENSOR_TIME_MIX_G2,       LLM_TENSOR_TIME_MIX_K_K,
                LLM_TENSOR_TIME_MIX_K_A,    LLM_TENSOR_TIME_MIX_R_K,      LLM_TENSOR_TIME_MIX_LERP_FUSED,
                ...
                LLM_TENSOR_CHANNEL_MIX_KEY, LLM_TENSOR_CHANNEL_MIX_VALUE,
            };
        ...
        case LLM_ARCH_GRANITE_MOE:
            return {
                LLM_TENSOR_TOKEN_EMBD,  LLM_TENSOR_OUTPUT_NORM,    LLM_TENSOR_OUTPUT,         LLM_TENSOR_ATTN_NORM,
                LLM_TENSOR_ATTN_Q,      LLM_TENSOR_ATTN_K,         LLM_TENSOR_ATTN_V,         LLM_TENSOR_ATTN_OUT,
                LLM_TENSOR_FFN_NORM,    LLM_TENSOR_FFN_GATE_INP,   LLM_TENSOR_FFN_GATE_EXPS,  LLM_TENSOR_FFN_DOWN_EXPS,
                LLM_TENSOR_FFN_UP_EXPS, LLM_TENSOR_FFN_GATE_SHEXP, LLM_TENSOR_FFN_DOWN_SHEXP, LLM_TENSOR_FFN_UP_SHEXP,
            };
        case LLM_ARCH_GRANITE_HYBRID:
            return {
                ...
                LLM_TENSOR_ATTN_K,         LLM_TENSOR_ATTN_V,         LLM_TENSOR_ATTN_OUT,      LLM_TENSOR_FFN_NORM,
                LLM_TENSOR_FFN_GATE,       LLM_TENSOR_FFN_DOWN,       LLM_TENSOR_FFN_UP,        LLM_TENSOR_FFN_NORM,
                LLM_TENSOR_FFN_GATE_INP,   LLM_TENSOR_FFN_GATE_EXPS,  LLM_TENSOR_FFN_DOWN_EXPS, LLM_TENSOR_FFN_UP_EXPS,
                LLM_TENSOR_FFN_GATE_SHEXP, LLM_TENSOR_FFN_DOWN_SHEXP, LLM_TENSOR_FFN_UP_SHEXP,
            };
        case LLM_ARCH_WAVTOKENIZER_DEC:
            return {
                ...
                LLM_TENSOR_CONVNEXT_PW2,   LLM_TENSOR_CONVNEXT_GAMMA,
                LLM_TENSOR_OUTPUT_NORM,    LLM_TENSOR_OUTPUT,
                LLM_TENSOR_POS_NET_CONV1,  LLM_TENSOR_POS_NET_CONV2,
                LLM_TENSOR_POS_NET_NORM,   LLM_TENSOR_POS_NET_NORM1,
                LLM_TENSOR_POS_NET_NORM2,  LLM_TENSOR_POS_NET_ATTN_NORM,
                LLM_TENSOR_POS_NET_ATTN_Q, LLM_TENSOR_POS_NET_ATTN_K,
                LLM_TENSOR_POS_NET_ATTN_V, LLM_TENSOR_POS_NET_ATTN_OUT,
            };
        case LLM_ARCH_BAILINGMOE:
            return {
                LLM_TENSOR_TOKEN_EMBD,     LLM_TENSOR_OUTPUT_NORM,    LLM_TENSOR_OUTPUT,
                LLM_TENSOR_ROPE_FREQS,     LLM_TENSOR_ATTN_NORM,      LLM_TENSOR_ATTN_Q,
                LLM_TENSOR_ATTN_K,         LLM_TENSOR_ATTN_V,         LLM_TENSOR_ATTN_OUT,
                LLM_TENSOR_FFN_GATE_INP,   LLM_TENSOR_FFN_NORM,       LLM_TENSOR_FFN_GATE_EXPS,
                LLM_TENSOR_FFN_DOWN_EXPS,  LLM_TENSOR_FFN_UP_EXPS,    LLM_TENSOR_FFN_GATE_INP_SHEXP,
                LLM_TENSOR_FFN_GATE_SHEXP, LLM_TENSOR_FFN_DOWN_SHEXP, LLM_TENSOR_FFN_UP_SHEXP,
            };
        ...
        case LLM_ARCH_ERNIE4_5_MOE:
            return {
                LLM_TENSOR_TOKEN_EMBD,   LLM_TENSOR_OUTPUT_NORM,     LLM_TENSOR_OUTPUT,
                LLM_TENSOR_ATTN_NORM,    LLM_TENSOR_ATTN_Q,          LLM_TENSOR_ATTN_K,
                LLM_TENSOR_ATTN_V,       LLM_TENSOR_ATTN_OUT,        LLM_TENSOR_FFN_NORM,
                LLM_TENSOR_FFN_GATE,     LLM_TENSOR_FFN_DOWN,        LLM_TENSOR_FFN_UP,
                LLM_TENSOR_FFN_GATE_INP, LLM_TENSOR_FFN_GATE_SHEXP,  LLM_TENSOR_FFN_DOWN_SHEXP,
                LLM_TENSOR_FFN_UP_SHEXP, LLM_TENSOR_FFN_GATE_EXPS,   LLM_TENSOR_FFN_DOWN_EXPS,
                LLM_TENSOR_FFN_UP_EXPS,  LLM_TENSOR_FFN_EXP_PROBS_B,
            };
        case LLM_ARCH_HUNYUAN_MOE:
            return {
                ...
                LLM_TENSOR_ATTN_Q,         LLM_TENSOR_ATTN_Q_NORM,    LLM_TENSOR_ATTN_K,       LLM_TENSOR_ATTN_K_NORM,
                LLM_TENSOR_ATTN_V,         LLM_TENSOR_ATTN_OUT,       LLM_TENSOR_FFN_GATE_INP, LLM_TENSOR_FFN_NORM,
                LLM_TENSOR_FFN_GATE_SHEXP, LLM_TENSOR_FFN_DOWN_SHEXP, LLM_TENSOR_FFN_UP_SHEXP, LLM_TENSOR_FFN_GATE_EXPS,
                LLM_TENSOR_FFN_DOWN_EXPS,  LLM_TENSOR_FFN_UP_EXPS,
            };
        case LLM_ARCH_OPENAI_MOE:
            return {
                LLM_TENSOR_TOKEN_EMBD,     LLM_TENSOR_OUTPUT_NORM, LLM_TENSOR_OUTPUT,       LLM_TENSOR_ATTN_NORM,
                LLM_TENSOR_ATTN_POST_NORM, LLM_TENSOR_ATTN_Q,      LLM_TENSOR_ATTN_K,       LLM_TENSOR_ATTN_V,
                LLM_TENSOR_ATTN_OUT,       LLM_TENSOR_ATTN_SINKS,  LLM_TENSOR_FFN_GATE_INP, LLM_TENSOR_FFN_GATE_EXPS,
                LLM_TENSOR_FFN_DOWN_EXPS,  LLM_TENSOR_FFN_UP_EXPS,
            };
        case LLM_ARCH_LFM2:
            return {
                LLM_TENSOR_ATTN_NORM,        LLM_TENSOR_ATTN_Q,
                LLM_TENSOR_ATTN_K,           LLM_TENSOR_ATTN_V,
                LLM_TENSOR_ATTN_OUT,         LLM_TENSOR_ATTN_K_NORM,
                LLM_TENSOR_ATTN_Q_NORM,      LLM_TENSOR_FFN_DOWN,
                LLM_TENSOR_FFN_GATE,         LLM_TENSOR_FFN_NORM,
                LLM_TENSOR_FFN_UP,           LLM_TENSOR_SHORTCONV_CONV,
                LLM_TENSOR_SHORTCONV_INPROJ, LLM_TENSOR_SHORTCONV_OUTPROJ,
                LLM_TENSOR_TOKEN_EMBD,       LLM_TENSOR_OUTPUT_NORM_LFM2,
                LLM_TENSOR_OUTPUT,           LLM_TENSOR_DENSE_2_OUT,
            };
        ...
        case LLM_ARCH_APERTUS:
            return {
                LLM_TENSOR_TOKEN_EMBD, LLM_TENSOR_OUTPUT_NORM, LLM_TENSOR_OUTPUT,      LLM_TENSOR_ROPE_FREQS,
                LLM_TENSOR_ATTN_NORM,  LLM_TENSOR_ATTN_Q,      LLM_TENSOR_ATTN_K,      LLM_TENSOR_ATTN_V,
                LLM_TENSOR_ATTN_OUT,   LLM_TENSOR_ATTN_Q_NORM, LLM_TENSOR_ATTN_K_NORM, LLM_TENSOR_FFN_NORM,
                LLM_TENSOR_FFN_DOWN,   LLM_TENSOR_FFN_UP,
            };
        case LLM_ARCH_SEED_OSS:
            return {
                LLM_TENSOR_TOKEN_EMBD,     LLM_TENSOR_OUTPUT_NORM, LLM_TENSOR_OUTPUT,   LLM_TENSOR_ATTN_NORM,
                LLM_TENSOR_ATTN_Q,         LLM_TENSOR_ATTN_K,      LLM_TENSOR_ATTN_V,   LLM_TENSOR_ATTN_OUT,
                LLM_TENSOR_ATTN_POST_NORM, LLM_TENSOR_FFN_GATE,    LLM_TENSOR_FFN_DOWN, LLM_TENSOR_FFN_UP,
            };
        case LLM_ARCH_GROVEMOE:
            return {
                LLM_TENSOR_TOKEN_EMBD,      LLM_TENSOR_OUTPUT_NORM,     LLM_TENSOR_OUTPUT,
                LLM_TENSOR_ATTN_NORM,       LLM_TENSOR_ATTN_Q,          LLM_TENSOR_ATTN_Q_NORM,
                LLM_TENSOR_ATTN_K,          LLM_TENSOR_ATTN_K_NORM,     LLM_TENSOR_ATTN_V,
                LLM_TENSOR_ATTN_OUT,        LLM_TENSOR_FFN_NORM,        LLM_TENSOR_FFN_GATE_INP,
                LLM_TENSOR_FFN_GATE_EXPS,   LLM_TENSOR_FFN_DOWN_EXPS,   LLM_TENSOR_FFN_UP_EXPS,
        ...
        case LLM_ARCH_MINIMAX_M2:
            return {
                LLM_TENSOR_TOKEN_EMBD,    LLM_TENSOR_OUTPUT_NORM,   LLM_TENSOR_OUTPUT,      LLM_TENSOR_ATTN_NORM,
                LLM_TENSOR_ATTN_Q,        LLM_TENSOR_ATTN_K,        LLM_TENSOR_ATTN_V,      LLM_TENSOR_ATTN_OUT,
                LLM_TENSOR_ATTN_Q_NORM,   LLM_TENSOR_ATTN_K_NORM,   LLM_TENSOR_FFN_NORM,    LLM_TENSOR_FFN_GATE_INP,
                LLM_TENSOR_FFN_GATE_EXPS, LLM_TENSOR_FFN_DOWN_EXPS, LLM_TENSOR_FFN_UP_EXPS, LLM_TENSOR_FFN_EXP_PROBS_B,
            };
        case LLM_ARCH_COGVLM:
            return {
                LLM_TENSOR_TOKEN_EMBD,      LLM_TENSOR_OUTPUT_NORM,     LLM_TENSOR_OUTPUT,
                LLM_TENSOR_ATTN_NORM,       LLM_TENSOR_ATTN_QKV,        LLM_TENSOR_ATTN_OUT,
                LLM_TENSOR_FFN_NORM,        LLM_TENSOR_FFN_GATE,        LLM_TENSOR_FFN_DOWN,
                LLM_TENSOR_FFN_UP,          LLM_TENSOR_VISEXP_ATTN_QKV, LLM_TENSOR_VISEXP_ATTN_OUT,
                LLM_TENSOR_VISEXP_FFN_GATE, LLM_TENSOR_VISEXP_FFN_DOWN, LLM_TENSOR_VISEXP_FFN_UP,
            };
        case LLM_ARCH_MIMO2:
            return {
                LLM_TENSOR_TOKEN_EMBD,  LLM_TENSOR_OUTPUT_NORM,     LLM_TENSOR_OUTPUT,        LLM_TENSOR_ATTN_NORM,
                LLM_TENSOR_ATTN_Q,      LLM_TENSOR_ATTN_K,          LLM_TENSOR_ATTN_V,        LLM_TENSOR_ATTN_SINKS,
                LLM_TENSOR_ATTN_OUT,    LLM_TENSOR_FFN_NORM,        LLM_TENSOR_FFN_GATE,      LLM_TENSOR_FFN_DOWN,
                LLM_TENSOR_FFN_UP,      LLM_TENSOR_FFN_GATE_INP,    LLM_TENSOR_FFN_GATE_EXPS, LLM_TENSOR_FFN_DOWN_EXPS,
                LLM_TENSOR_FFN_UP_EXPS, LLM_TENSOR_FFN_EXP_PROBS_B,
            };
