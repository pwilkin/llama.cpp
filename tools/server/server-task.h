...
struct server_task {
    ...
    task_result_state create_state() const { return task_result_state(params.oaicompat_chat_syntax); }
};
...
struct server_task_result_cmpl_final : server_task_result {
    ...
    virtual void update(task_result_state & state) override {
        is_updated = true;
        oaicompat_msg =
            state.update_chat_msg(content, false, oaicompat_msg_diffs, res_type == TASK_RESPONSE_TYPE_OAI_CHAT);
    }
